...
*Api.CampaignApi* | [**getTtwCampaigns**](docs/CampaignApi.md#getTtwCampaigns) | **GET** /ttw/companies/{company_id}/campaigns | Gets a list TTW campaigns for a given company
*Api.CampaignApi* | [**getUserTtwReservation**](docs/CampaignApi.md#getUserTtwReservation) | **GET** /ttw/campaign/{id}/reservation/{reservation_uuid} | Gets User ID for a TTW reservation
...
*Api.CompanyApi* | [**createEmailTemplate**](docs/CompanyApi.md#createEmailTemplate) | **POST** /companies/{id}/news_releases/email_templates | Creates an email template
...
*Api.CompanyApi* | [**deleteEmailTemplate**](docs/CompanyApi.md#deleteEmailTemplate) | **DELETE** /companies/{id}/news_releases/email_templates/{template_id} | Deletes an email template
...
*Api.CompanyApi* | [**getEmailTemplate**](docs/CompanyApi.md#getEmailTemplate) | **GET** /companies/{id}/news_releases/email_templates/{template_id} | Get an email template
...
*Api.CompanyApi* | [**testDocumentUploadEmail**](docs/CompanyApi.md#testDocumentUploadEmail) | **POST** /companies/{id}/documents/test_upload_email | Send document upload test email to given user
...
*Api.DealApi* | [**achBankAccountSetupIntent**](docs/DealApi.md#achBankAccountSetupIntent) | **GET** /deals/{id}/investor/{investor_id}/subscription/{subscription_id}/payments/ach/bank_account_setup_intent | Prepares an investor for payment
*Api.DealApi* | [**acssBankAccountSetupIntent**](docs/DealApi.md#acssBankAccountSetupIntent) | **GET** /deals/{id}/investor/{investor_id}/subscription/{subscription_id}/payments/acss/bank_account_setup_intent | Prepares an investor for payment
...
*Api.DealApi* | [**getPlatformEmailPage**](docs/DealApi.md#getPlatformEmailPage) | **GET** /deals/{id}/platform_emails/{kind}/page | Get the Page for a given Platform Email
*Api.DealApi* | [**listDeals**](docs/DealApi.md#listDeals) | **GET** /deals | List available deals
*Api.DealApi* | [**listPlatformEmails**](docs/DealApi.md#listPlatformEmails) | **GET** /deals/{id}/platform_emails | Get a list of platform emails for the deal
*Api.DealApi* | [**patchPlatformEmail**](docs/DealApi.md#patchPlatformEmail) | **PATCH** /deals/{id}/platform_emails/{kind}/update | Patch platform email by kind and deal.
*Api.DealApi* | [**patchPlatformEmailPage**](docs/DealApi.md#patchPlatformEmailPage) | **PATCH** /deals/{id}/platform_emails/{kind}/page | Create and associate a page with a platform email or update the existing page
*Api.DealsApi* | [**postDealsIdEmailCampaignEmailCampaignIdSendEmail**](docs/DealsApi.md#postDealsIdEmailCampaignEmailCampaignIdSendEmail) | **POST** /deals/{id}/email_campaign/{email_campaign_id}/send_email | Send emails to all the investors invited to the material change campaign
...
*Api.DefaultApi* | [**getDealsIdPlatformEmailsDomain**](docs/DefaultApi.md#getDealsIdPlatformEmailsDomain) | **GET** /deals/{id}/platform_emails/domain | Get the email domain settings for the deal
...
*Api.DefaultApi* | [**patchDealsIdPlatformEmailsDomain**](docs/DefaultApi.md#patchDealsIdPlatformEmailsDomain) | **PATCH** /deals/{id}/platform_emails/domain | Update the email domain settings for the deal
...
*Api.DefaultApi* | [**postInvestorsInvestorIdDeleteInvestmentProcess**](docs/DefaultApi.md#postInvestorsInvestorIdDeleteInvestmentProcess) | **POST** /investors/{investor_id}/delete_investment/process | Delete investment
*Api.DefaultApi* | [**postInvestorsInvestorIdTransactionsRequestRefundProcess**](docs/DefaultApi.md#postInvestorsInvestorIdTransactionsRequestRefundProcess) | **POST** /investors/{investor_id}/transactions/request_refund/process | Request refund for investor transactions
...
*Api.InvestorProfileApi* | [**patchManagedProfile**](docs/InvestorProfileApi.md#patchManagedProfile) | **PATCH** /investor_profiles/managed/{investor_profile_id} | Patch managed investor profile.
...
*Api.PaymentsApi* | [**postDealInvestorPaymentsIra**](docs/PaymentsApi.md#postDealInvestorPaymentsIra) | **POST** /deals/{id}/investors/{investor_id}/payments/ira | Creates a payment intent for express wire and mail its instructions.
*Api.ReservationApi* | [**createReservation**](docs/ReservationApi.md#createReservation) | **POST** /ttw/reservations | Create a new reservation
*Api.ReservationApi* | [**getTtwReservation**](docs/ReservationApi.md#getTtwReservation) | **GET** /ttw/reservations/{id} | Gets a TTW reservation
...
*Api.ShwApi* | [**getShwPage**](docs/ShwApi.md#getShwPage) | **GET** /shw/{id}/page | Get self hosted website page
*Api.ShwApi* | [**publishShwPage**](docs/ShwApi.md#publishShwPage) | **PATCH** /shw/{id}/page/publish | Publish self hosted website page
*Api.TtwCampaignsApi* | [**getTtwCampaignPage**](docs/TtwCampaignsApi.md#getTtwCampaignPage) | **GET** /ttw/campaigns/{id}/page | Get ttw campaign page
*Api.TtwCampaignsApi* | [**publishTtwCampaignPage**](docs/TtwCampaignsApi.md#publishTtwCampaignPage) | **PATCH** /ttw/campaigns/{id}/page/publish | Publish ttw campaign page
...
*Api.UserApi* | [**getVerificationResources**](docs/UserApi.md#getVerificationResources) | **GET** /users/verification/resources | Gets the verification process resources
*Api.UserApi* | [**sendVerificationCode**](docs/UserApi.md#sendVerificationCode) | **POST** /users/verification/send_code | Sends the verification code to the user
...
*Api.UserApi* | [**verifyFactor**](docs/UserApi.md#verifyFactor) | **PUT** /users/{id}/verify_factor | Creates an API endpoint to verify an existing TOTP factor
*Api.UserApi* | [**verifySmsVerification**](docs/UserApi.md#verifySmsVerification) | **POST** /users/{id}/verify_sms_verification | Verify a SMS Verification by creating a two factor channel of sms type
*Api.UsersApi* | [**getUsersIdContexts**](docs/UsersApi.md#getUsersIdContexts) | **GET** /users/{id}/contexts | Get contexts for a user
...
## Documentation for Models
 ...
 - [Api.CreateReservationRequest](docs/CreateReservationRequest.md)
 ...
 - [Api.PatchDealsIdPlatformEmailsDomainRequest](docs/PatchDealsIdPlatformEmailsDomainRequest.md)
 ...
 - [Api.PatchInvestorProfilesManaged](docs/PatchInvestorProfilesManaged.md)
 ...
 - [Api.PatchPlatformEmailPageRequest](docs/PatchPlatformEmailPageRequest.md)
 - [Api.PatchPlatformEmailRequest](docs/PatchPlatformEmailRequest.md)
 ...
 - [Api.RequestNewDocumentRequest](docs/RequestNewDocumentRequest.md)
 ...
 - [Api.SendVerificationCodeRequest](docs/SendVerificationCodeRequest.md)
 - [Api.SetupSmsVerificationRequest](docs/SetupSmsVerificationRequest.md)
 - [Api.TestDocumentUploadEmailRequest](docs/TestDocumentUploadEmailRequest.md)
 ...
 - [Api.V1EntitiesDealsInvestorsPaymentAchBankAccountSetupIntent](docs/V1EntitiesDealsInvestorsPaymentAchBankAccountSetupIntent.md)
 - [Api.V1EntitiesDealsInvestorsPaymentAcssBankAccountSetupIntent](docs/V1EntitiesDealsInvestorsPaymentAcssBankAccountSetupIntent.md)
 - [Api.V1EntitiesDealsPlatformEmail](docs/V1EntitiesDealsPlatformEmail.md)
 - [Api.V1EntitiesDealsPlatformEmails](docs/V1EntitiesDealsPlatformEmails.md)
 - [Api.V1EntitiesDealsPlatformEmailsDomainSettings](docs/V1EntitiesDealsPlatformEmailsDomainSettings.md)
 ...
 - [Api.V1EntitiesDealsProgressPageSummaryItem](docs/V1EntitiesDealsProgressPageSummaryItem.md)
 ...
 - [Api.V1EntitiesPage](docs/V1EntitiesPage.md)
 ...
 - [Api.V1EntitiesTtwCampaignList](docs/V1EntitiesTtwCampaignList.md)
 - [Api.V1EntitiesTtwCampaignResponse](docs/V1EntitiesTtwCampaignResponse.md)
 - [Api.V1EntitiesTtwReservationCreate](docs/V1EntitiesTtwReservationCreate.md)
 - [Api.V1EntitiesTtwReservationGetResponse](docs/V1EntitiesTtwReservationGetResponse.md)
 - [Api.V1EntitiesTtwReservationResponse](docs/V1EntitiesTtwReservationResponse.md)
 - [Api.V1EntitiesUser](docs/V1EntitiesUser.md)
 - [Api.V1EntitiesUsersBinding](docs/V1EntitiesUsersBinding.md)
 - [Api.V1EntitiesUsersContext](docs/V1EntitiesUsersContext.md)
 - [Api.V1EntitiesUsersContexts](docs/V1EntitiesUsersContexts.md)
 - [Api.V1EntitiesUsersFactor](docs/V1EntitiesUsersFactor.md)
 - [Api.V1EntitiesUsersTwoFactorChannel](docs/V1EntitiesUsersTwoFactorChannel.md)
 - [Api.V1EntitiesUsersTwoFactorChannels](docs/V1EntitiesUsersTwoFactorChannels.md)
 - [Api.V1EntitiesUsersVerificationResources](docs/V1EntitiesUsersVerificationResources.md)
 ...
 - [Api.VerifyFactorRequest](docs/VerifyFactorRequest.md)
 - [Api.VerifySmsVerificationRequest](docs/VerifySmsVerificationRequest.md)
