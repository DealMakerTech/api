...
*Api.InvestorApi* | [**runBackgroundSearch**](docs/InvestorApi.md#runBackgroundSearch) | **POST** /deals/{id}/investors/{investor_id}/background_checks/{search_entity_id}/run | Run Alloy background search for the investor
...
## Documentation for Models
 ...
 - [Api.V1EntitiesInvestorIncentivePlan](docs/V1EntitiesInvestorIncentivePlan.md)
 - [Api.V1EntitiesInvestorIncentiveTier](docs/V1EntitiesInvestorIncentiveTier.md)
 - [Api.V1EntitiesInvestorOtpAccessLink](docs/V1EntitiesInvestorOtpAccessLink.md)
 - [Api.V1EntitiesInvestorPriceDetails](docs/V1EntitiesInvestorPriceDetails.md)
