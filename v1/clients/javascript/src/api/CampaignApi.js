...
export default class CampaignApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getTtwCampaign operation.
     * @callback module:api/CampaignApi~getTtwCampaignCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1EntitiesTtwCampaignResponse} data The data returned by the service call.
     ...
     * Gets a TTW campaign for a given company
     * @param {Number} id 
     * @param {module:api/CampaignApi~getTtwCampaignCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1EntitiesTtwCampaignResponse}
     */
    getTtwCampaign(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getTtwCampaign");
      }
