...
export default class DealsApi {
    ...
    */
     ...
     * @callback module:api/DealsApi~putDealsIdScriptTagEnvironmentCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Update script tag environment for the deal.
     * @param {Number} id The deal id.
     * @param {module:model/PutDealsIdScriptTagEnvironmentRequest} putDealsIdScriptTagEnvironmentRequest 
     * @param {module:api/DealsApi~putDealsIdScriptTagEnvironmentCallback} callback The callback function, accepting three arguments: error, data, response
     */
    putDealsIdScriptTagEnvironment(id, putDealsIdScriptTagEnvironmentRequest, callback) {
      let postBody = putDealsIdScriptTagEnvironmentRequest;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling putDealsIdScriptTagEnvironment");
      }
      // verify the required parameter 'putDealsIdScriptTagEnvironmentRequest' is set
      if (putDealsIdScriptTagEnvironmentRequest === undefined || putDealsIdScriptTagEnvironmentRequest === null) {
        throw new Error("Missing the required parameter 'putDealsIdScriptTagEnvironmentRequest' when calling putDealsIdScriptTagEnvironment");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/deals/{id}/script_tag_environment', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
