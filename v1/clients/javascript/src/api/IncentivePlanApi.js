...
export default class IncentivePlanApi {
    ...
    /**
    * Constructs a new IncentivePlanApi. 
    * @alias module:api/IncentivePlanApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getDealIncentivePlansTime operation.
     * @callback module:api/IncentivePlanApi~getDealIncentivePlansTimeCallback
     ...
     * @param {module:api/IncentivePlanApi~getDealIncentivePlansTimeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1EntitiesDealsPriceDetails}
     */
    getDealIncentivePlansTime(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getDealIncentivePlansTime");
      }
