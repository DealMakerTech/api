...
export default class InvestorProfileApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getInvestorProfiles operation.
     * @callback module:api/InvestorProfileApi~getInvestorProfilesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1EntitiesInvestorProfiles} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/V1EntitiesInvestorProfiles}
     */
    getInvestorProfiles(opts, callback) {
      opts = opts || {};
      let postBody = null;
