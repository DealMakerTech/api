...
export default class InvestorProfileApi {
    ...
    /**
    * Constructs a new InvestorProfileApi. 
    * @alias module:api/InvestorProfileApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createInvestorProfile operation.
     * @callback module:api/InvestorProfileApi~createInvestorProfileCallback
     ...
     * @param {module:api/InvestorProfileApi~createInvestorProfileCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1EntitiesInvestorProfileIndividual}
     */
    createInvestorProfile(UNKNOWN_BASE_TYPE, callback) {
      let postBody = UNKNOWN_BASE_TYPE;
      // verify the required parameter 'UNKNOWN_BASE_TYPE' is set
      if (UNKNOWN_BASE_TYPE === undefined || UNKNOWN_BASE_TYPE === null) {
        throw new Error("Missing the required parameter 'UNKNOWN_BASE_TYPE' when calling createInvestorProfile");
      }
