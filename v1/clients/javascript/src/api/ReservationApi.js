...
export default class ReservationApi {
    ...
    */
    ...
    createReservation(createReservationRequest, callback) {
      ...
      if (createReservationRequest === undefined || createReservationRequest === null) {
        throw new Error("Missing the required parameter 'createReservationRequest' when calling createReservation");
      }
