...
export default class ShareholderApi {
    ...
    */
     ...
     * @param {module:model/V1EntitiesShareholders} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/V1EntitiesShareholders}
     */
    getShareholders(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getShareholders");
      }
