...
export default class UsersApi {
    ...
    */
     ...
     * @callback module:api/UsersApi~getUsersInvestmentsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsersApi~getUsersInvestmentsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1EntitiesInvestors}
     */
    getUsersInvestments(email, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'email' is set
      if (email === undefined || email === null) {
        throw new Error("Missing the required parameter 'email' when calling getUsersInvestments");
      }
