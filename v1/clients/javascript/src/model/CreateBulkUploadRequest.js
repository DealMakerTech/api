...
class CreateBulkUploadRequest {
     ...
     * @param jsonNotificationMessage {Object} JSON notification message
     */
    constructor(fileIdentifier, documentType, uploadName, sendNotification, notificationMessage, jsonNotificationMessage) { 
        
        CreateBulkUploadRequest.initialize(this, fileIdentifier, documentType, uploadName, sendNotification, notificationMessage, jsonNotificationMessage);
    }
     ...
     */
    static initialize(obj, fileIdentifier, documentType, uploadName, sendNotification, notificationMessage, jsonNotificationMessage) { 
        ...
        obj['json_notification_message'] = jsonNotificationMessage;
    }

    /**
     * Constructs a <code>CreateBulkUploadRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBulkUploadRequest} obj Optional instance to populate.
     * @return {module:model/CreateBulkUploadRequest} The populated <code>CreateBulkUploadRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('json_notification_message')) {
                obj['json_notification_message'] = ApiClient.convertToType(data['json_notification_message'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBulkUploadRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBulkUploadRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateBulkUploadRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['file_identifier'] && !(typeof data['file_identifier'] === 'string' || data['file_identifier'] instanceof String)) {
            throw new Error("Expected the field `file_identifier` to be a primitive type in the JSON string but got " + data['file_identifier']);
        }
        // ensure the json data is a string
...
CreateBulkUploadRequest.RequiredProperties = ["file_identifier", "document_type", "upload_name", "send_notification", "notification_message", "json_notification_message"];

/**
 * The file identifier
 * @member {String} file_identifier
 */
CreateBulkUploadRequest.prototype['file_identifier'] = undefined;
 ...
 * @member {Object} json_notification_message
 */
CreateBulkUploadRequest.prototype['json_notification_message'] = undefined;
...
export default CreateBulkUploadRequest;
