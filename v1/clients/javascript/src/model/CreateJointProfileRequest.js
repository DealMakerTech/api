...
class CreateJointProfileRequest {
    /**
     * Constructs a new <code>CreateJointProfileRequest</code>.
     * @alias module:model/CreateJointProfileRequest
     * @param email {String} User email which is associated with investor profile.
     */
    constructor(email) { 
        
        CreateJointProfileRequest.initialize(this, email);
    }
    ...
    /**
     * Constructs a <code>CreateJointProfileRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateJointProfileRequest} obj Optional instance to populate.
     * @return {module:model/CreateJointProfileRequest} The populated <code>CreateJointProfileRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateJointProfileRequest();
            ...
            if (data.hasOwnProperty('joint_holder_country')) {
                obj['joint_holder_country'] = ApiClient.convertToType(data['joint_holder_country'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateJointProfileRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateJointProfileRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateJointProfileRequest.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['joint_holder_country'] && !(typeof data['joint_holder_country'] === 'string' || data['joint_holder_country'] instanceof String)) {
            throw new Error("Expected the field `joint_holder_country` to be a primitive type in the JSON string but got " + data['joint_holder_country']);
        }
        // ensure the json data is a string
...
CreateJointProfileRequest.RequiredProperties = ["email"];

/**
 * User email which is associated with investor profile.
 * @member {String} email
 */
CreateJointProfileRequest.prototype['email'] = undefined;

/**
 * The United States accredited investor information.
 * @member {module:model/CreateJointProfileRequest.UsAccreditedCategoryEnum} us_accredited_category
 */
CreateJointProfileRequest.prototype['us_accredited_category'] = undefined;

/**
 * The Canadian accredited investor information.
 * @member {module:model/CreateJointProfileRequest.CaAccreditedInvestorEnum} ca_accredited_investor
 */
CreateJointProfileRequest.prototype['ca_accredited_investor'] = undefined;

/**
 * The types of joint investor.
 * @member {module:model/CreateJointProfileRequest.JointTypeEnum} joint_type
 */
CreateJointProfileRequest.prototype['joint_type'] = undefined;

/**
 * The first name of the primary holder (required).
 * @member {String} first_name
 */
CreateJointProfileRequest.prototype['first_name'] = undefined;

/**
 * The last name of the primary holder (required).
 * @member {String} last_name
 */
CreateJointProfileRequest.prototype['last_name'] = undefined;

/**
 * The suffix of the primary holder.
 * @member {String} suffix
 */
CreateJointProfileRequest.prototype['suffix'] = undefined;

/**
 * The country the primary holder (required).
 * @member {String} country
 */
CreateJointProfileRequest.prototype['country'] = undefined;

/**
 * The street address of the primary holder (required).
 * @member {String} street_address
 */
CreateJointProfileRequest.prototype['street_address'] = undefined;

/**
 * The street address line 2 of the primary holder.
 * @member {String} unit2
 */
CreateJointProfileRequest.prototype['unit2'] = undefined;

/**
 * The city of the primary holder (required).
 * @member {String} city
 */
CreateJointProfileRequest.prototype['city'] = undefined;

/**
 * The region or State of the primary holder (required).
 * @member {String} region
 */
CreateJointProfileRequest.prototype['region'] = undefined;

/**
 * The postal code or zipcode of the primary holder (required).
 * @member {String} postal_code
 */
CreateJointProfileRequest.prototype['postal_code'] = undefined;

/**
 * The date of birth of the primary holder (required).
 * @member {String} date_of_birth
 */
CreateJointProfileRequest.prototype['date_of_birth'] = undefined;

/**
 * The taxpayer identification number of the primary holder (required).
 * @member {String} taxpayer_id
 */
CreateJointProfileRequest.prototype['taxpayer_id'] = undefined;

/**
 * The phone number of the primary holder (required).
 * @member {String} phone_number
 */
CreateJointProfileRequest.prototype['phone_number'] = undefined;

/**
 * The income of the primary holder.
 * @member {Number} income
 */
CreateJointProfileRequest.prototype['income'] = undefined;

/**
 * The net worth of the primary holder.
 * @member {Number} net_worth
 */
CreateJointProfileRequest.prototype['net_worth'] = undefined;

/**
 * The prior offerings amount of the primary holder.
 * @member {Number} reg_cf_prior_offerings_amount
 */
CreateJointProfileRequest.prototype['reg_cf_prior_offerings_amount'] = undefined;

/**
 * The first name of the joint holder (required).
 * @member {String} joint_holder_first_name
 */
CreateJointProfileRequest.prototype['joint_holder_first_name'] = undefined;

/**
 * The last name of the joint holder (required).
 * @member {String} joint_holder_last_name
 */
CreateJointProfileRequest.prototype['joint_holder_last_name'] = undefined;

/**
 * The suffix of the joint holder.
 * @member {String} joint_holder_suffix
 */
CreateJointProfileRequest.prototype['joint_holder_suffix'] = undefined;

/**
 * The country of the joint holder (required).
 * @member {String} joint_holder_country
 */
CreateJointProfileRequest.prototype['joint_holder_country'] = undefined;

/**
 * The street address of the joint holder (required).
 * @member {String} joint_holder_street_address
 */
CreateJointProfileRequest.prototype['joint_holder_street_address'] = undefined;

/**
 * The street address line 2 of the joint holder.
 * @member {String} joint_holder_unit2
 */
CreateJointProfileRequest.prototype['joint_holder_unit2'] = undefined;

/**
 * The city of the joint holder (required).
 * @member {String} joint_holder_city
 */
CreateJointProfileRequest.prototype['joint_holder_city'] = undefined;

/**
 * The region or state of the joint holder (required).
 * @member {String} joint_holder_region
 */
CreateJointProfileRequest.prototype['joint_holder_region'] = undefined;

/**
 * The postal code or zipcode of the joint holder (required).
 * @member {String} joint_holder_postal_code
 */
CreateJointProfileRequest.prototype['joint_holder_postal_code'] = undefined;

/**
 * The date of birth of the joint holder (required).
 * @member {String} joint_holder_date_of_birth
 */
CreateJointProfileRequest.prototype['joint_holder_date_of_birth'] = undefined;

/**
 * The taxpayer identification number of the joint holder (required).
 * @member {String} joint_holder_taxpayer_id
 */
CreateJointProfileRequest.prototype['joint_holder_taxpayer_id'] = undefined;
 ...
 * @readonly
 */
CreateJointProfileRequest['UsAccreditedCategoryEnum'] = {
 ...
 * @readonly
 */
CreateJointProfileRequest['CaAccreditedInvestorEnum'] = {
 ...
 * @readonly
 */
CreateJointProfileRequest['JointTypeEnum'] = {
...
export default CreateJointProfileRequest;
