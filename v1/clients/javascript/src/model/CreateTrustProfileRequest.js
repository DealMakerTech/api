...
class CreateTrustProfileRequest {
    /**
     * Constructs a new <code>CreateTrustProfileRequest</code>.
     * @alias module:model/CreateTrustProfileRequest
     * @param email {String} User email which is associated with investor profile (required).
     */
    constructor(email) { 
        
        CreateTrustProfileRequest.initialize(this, email);
    }
    ...
    /**
     * Constructs a <code>CreateTrustProfileRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTrustProfileRequest} obj Optional instance to populate.
     * @return {module:model/CreateTrustProfileRequest} The populated <code>CreateTrustProfileRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTrustProfileRequest();
            ...
            if (data.hasOwnProperty('trustees[first_name]')) {
                obj['trustees[first_name]'] = ApiClient.convertToType(data['trustees[first_name]'], ['String']);
            }
            if (data.hasOwnProperty('trustees[last_name]')) {
                obj['trustees[last_name]'] = ApiClient.convertToType(data['trustees[last_name]'], ['String']);
            }
            if (data.hasOwnProperty('trustees[suffix]')) {
                obj['trustees[suffix]'] = ApiClient.convertToType(data['trustees[suffix]'], ['String']);
            }
            if (data.hasOwnProperty('trustees[country]')) {
                obj['trustees[country]'] = ApiClient.convertToType(data['trustees[country]'], ['String']);
            }
            ...
            if (data.hasOwnProperty('trustees[region]')) {
                obj['trustees[region]'] = ApiClient.convertToType(data['trustees[region]'], ['String']);
            }
            if (data.hasOwnProperty('trustees[postal_code]')) {
                obj['trustees[postal_code]'] = ApiClient.convertToType(data['trustees[postal_code]'], ['String']);
            }
            if (data.hasOwnProperty('trustees[date_of_birth]')) {
                obj['trustees[date_of_birth]'] = ApiClient.convertToType(data['trustees[date_of_birth]'], ['String']);
            }
            if (data.hasOwnProperty('trustees[taxpayer_id]')) {
                obj['trustees[taxpayer_id]'] = ApiClient.convertToType(data['trustees[taxpayer_id]'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTrustProfileRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTrustProfileRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateTrustProfileRequest.RequiredProperties) {
            if (!data[property]) {
        ...
        if (!Array.isArray(data['trustees[first_name]'])) {
            throw new Error("Expected the field `trustees[first_name]` to be an array in the JSON data but got " + data['trustees[first_name]']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['trustees[last_name]'])) {
            throw new Error("Expected the field `trustees[last_name]` to be an array in the JSON data but got " + data['trustees[last_name]']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['trustees[suffix]'])) {
            throw new Error("Expected the field `trustees[suffix]` to be an array in the JSON data but got " + data['trustees[suffix]']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['trustees[country]'])) {
            throw new Error("Expected the field `trustees[country]` to be an array in the JSON data but got " + data['trustees[country]']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['trustees[street_address]'])) {
        ...
        if (!Array.isArray(data['trustees[city]'])) {
            throw new Error("Expected the field `trustees[city]` to be an array in the JSON data but got " + data['trustees[city]']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['trustees[region]'])) {
            throw new Error("Expected the field `trustees[region]` to be an array in the JSON data but got " + data['trustees[region]']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['trustees[postal_code]'])) {
            throw new Error("Expected the field `trustees[postal_code]` to be an array in the JSON data but got " + data['trustees[postal_code]']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['trustees[date_of_birth]'])) {
            throw new Error("Expected the field `trustees[date_of_birth]` to be an array in the JSON data but got " + data['trustees[date_of_birth]']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['trustees[taxpayer_id]'])) {
            throw new Error("Expected the field `trustees[taxpayer_id]` to be an array in the JSON data but got " + data['trustees[taxpayer_id]']);
        }
...
CreateTrustProfileRequest.RequiredProperties = ["email"];
 ...
 * @member {String} name
 */
CreateTrustProfileRequest.prototype['name'] = undefined;

/**
 * The creation date of the trust (required).
 * @member {String} date
 */
CreateTrustProfileRequest.prototype['date'] = undefined;

/**
 * The country of the trust (required).
 * @member {String} country
 */
CreateTrustProfileRequest.prototype['country'] = undefined;

/**
 * Trust street address of the trust (required).
 * @member {String} street_address
 */
CreateTrustProfileRequest.prototype['street_address'] = undefined;

/**
 * The street address line 2 of the trust.
 * @member {String} unit2
 */
CreateTrustProfileRequest.prototype['unit2'] = undefined;

/**
 * The city of the trust (required).
 * @member {String} city
 */
CreateTrustProfileRequest.prototype['city'] = undefined;

/**
 * The region or state of the trust (required).
 * @member {String} region
 */
CreateTrustProfileRequest.prototype['region'] = undefined;

/**
 * The postal code or zipcode of the trust (required).
 * @member {String} postal_code
 */
CreateTrustProfileRequest.prototype['postal_code'] = undefined;

/**
 * The phone number of the trust (required).
 * @member {String} phone_number
 */
CreateTrustProfileRequest.prototype['phone_number'] = undefined;

/**
 * The income of the trust.
 * @member {Number} income
 */
CreateTrustProfileRequest.prototype['income'] = undefined;

/**
 * The net worth of the trust.
 * @member {Number} net_worth
 */
CreateTrustProfileRequest.prototype['net_worth'] = undefined;

/**
 * The prior offering amount of the trust.
 * @member {Number} reg_cf_prior_offerings_amount
 */
CreateTrustProfileRequest.prototype['reg_cf_prior_offerings_amount'] = undefined;

/**
 * The list of first names for the trustees (required for trustee 1).
 * @member {Array.<String>} trustees[first_name]
 */
CreateTrustProfileRequest.prototype['trustees[first_name]'] = undefined;

/**
 * The list of last names for the trustees (required for trustee 1).
 * @member {Array.<String>} trustees[last_name]
 */
CreateTrustProfileRequest.prototype['trustees[last_name]'] = undefined;

/**
 * The list of suffixes for the trustees.
 * @member {Array.<String>} trustees[suffix]
 */
CreateTrustProfileRequest.prototype['trustees[suffix]'] = undefined;

/**
 * The list of countries for the trustees (required for trustee 1).
 * @member {Array.<String>} trustees[country]
 */
CreateTrustProfileRequest.prototype['trustees[country]'] = undefined;

/**
 * The list of street addresses for the trustees (required for trustee 1).
 * @member {Array.<String>} trustees[street_address]
 */
CreateTrustProfileRequest.prototype['trustees[street_address]'] = undefined;
 ...
 * @member {Array.<String>} trustees[city]
 */
CreateTrustProfileRequest.prototype['trustees[city]'] = undefined;

/**
 * The list of regions or states for the trustees (required for trustee 1).
 * @member {Array.<String>} trustees[region]
 */
CreateTrustProfileRequest.prototype['trustees[region]'] = undefined;

/**
 * The list of postal codes or zipcodes for the trustees (required) for trustee 1.
 * @member {Array.<String>} trustees[postal_code]
 */
CreateTrustProfileRequest.prototype['trustees[postal_code]'] = undefined;

/**
 * The list of dates of birth for the trustees (required for trustee 1).
 * @member {Array.<String>} trustees[date_of_birth]
 */
CreateTrustProfileRequest.prototype['trustees[date_of_birth]'] = undefined;

/**
 * The list of taxpayer identification numbers for the trustees (required for trustee 1).
 * @member {Array.<String>} trustees[taxpayer_id]
 */
CreateTrustProfileRequest.prototype['trustees[taxpayer_id]'] = undefined;
 ...
 * @readonly
 */
CreateTrustProfileRequest['UsAccreditedCategoryEnum'] = {
...
export default CreateTrustProfileRequest;
