...
class PatchIndividualProfileRequest {
    /**
     * Constructs a new <code>PatchIndividualProfileRequest</code>.
     * @alias module:model/PatchIndividualProfileRequest
     */
    constructor() { 
        
        PatchIndividualProfileRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PatchIndividualProfileRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchIndividualProfileRequest} obj Optional instance to populate.
     * @return {module:model/PatchIndividualProfileRequest} The populated <code>PatchIndividualProfileRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchIndividualProfileRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchIndividualProfileRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchIndividualProfileRequest</code>.
     */
 ...
 * @member {module:model/PatchIndividualProfileRequest.UsAccreditedCategoryEnum} us_accredited_category
 */
PatchIndividualProfileRequest.prototype['us_accredited_category'] = undefined;

/**
 * The Canadian accredited investor information.
 * @member {module:model/PatchIndividualProfileRequest.CaAccreditedInvestorEnum} ca_accredited_investor
 */
PatchIndividualProfileRequest.prototype['ca_accredited_investor'] = undefined;

/**
 * The first name of the individual investor profile.
 * @member {String} first_name
 */
PatchIndividualProfileRequest.prototype['first_name'] = undefined;

/**
 * The last name of the individual investor profile.
 * @member {String} last_name
 */
PatchIndividualProfileRequest.prototype['last_name'] = undefined;

/**
 * The suffix of the individual investor profile.
 * @member {String} suffix
 */
PatchIndividualProfileRequest.prototype['suffix'] = undefined;

/**
 * The date of birth of the investor profile.
 * @member {String} date_of_birth
 */
PatchIndividualProfileRequest.prototype['date_of_birth'] = undefined;

/**
 * The taxpayer identification number of the investor profile.
 * @member {String} taxpayer_id
 */
PatchIndividualProfileRequest.prototype['taxpayer_id'] = undefined;

/**
 * The phone number of the investor profile.
 * @member {String} phone_number
 */
PatchIndividualProfileRequest.prototype['phone_number'] = undefined;

/**
 * The country of the individual investor profile.
 * @member {String} country
 */
PatchIndividualProfileRequest.prototype['country'] = undefined;

/**
 * The street address of the individual investor profile.
 * @member {String} street_address
 */
PatchIndividualProfileRequest.prototype['street_address'] = undefined;

/**
 * The street address line 2 of the individual investor profile.
 * @member {String} unit2
 */
PatchIndividualProfileRequest.prototype['unit2'] = undefined;

/**
 * The city of the individual investor profile.
 * @member {String} city
 */
PatchIndividualProfileRequest.prototype['city'] = undefined;

/**
 * The region or state of the individual investor profile.
 * @member {String} region
 */
PatchIndividualProfileRequest.prototype['region'] = undefined;

/**
 * The postal code or zipcode of the individual investor profile.
 * @member {String} postal_code
 */
PatchIndividualProfileRequest.prototype['postal_code'] = undefined;

/**
 * The income of the individual investor profile
 * @member {Number} income
 */
PatchIndividualProfileRequest.prototype['income'] = undefined;

/**
 * The net worth of the individual investor profile
 * @member {Number} net_worth
 */
PatchIndividualProfileRequest.prototype['net_worth'] = undefined;

/**
 * The prior offering amount of the individual investor profile
 * @member {Number} reg_cf_prior_offerings_amount
 */
PatchIndividualProfileRequest.prototype['reg_cf_prior_offerings_amount'] = undefined;
 ...
 * @readonly
 */
PatchIndividualProfileRequest['UsAccreditedCategoryEnum'] = {
 ...
 * @readonly
 */
PatchIndividualProfileRequest['CaAccreditedInvestorEnum'] = {
...
export default PatchIndividualProfileRequest;
