...
class PatchInvestorProfilesIndividuals {
    /**
     * Constructs a new <code>PatchInvestorProfilesIndividuals</code>.
     * Patch individual investor profile.
     * @alias module:model/PatchInvestorProfilesIndividuals
     */
    constructor() { 
        
        PatchInvestorProfilesIndividuals.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PatchInvestorProfilesIndividuals</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchInvestorProfilesIndividuals} obj Optional instance to populate.
     * @return {module:model/PatchInvestorProfilesIndividuals} The populated <code>PatchInvestorProfilesIndividuals</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PatchInvestorProfilesIndividuals</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
 ...
 * @member {module:model/PatchInvestorProfilesIndividuals.UsAccreditedCategoryEnum} us_accredited_category
 */
PatchInvestorProfilesIndividuals.prototype['us_accredited_category'] = undefined;

/**
 * The Canadian accredited investor information.
 * @member {module:model/PatchInvestorProfilesIndividuals.CaAccreditedInvestorEnum} ca_accredited_investor
 */
PatchInvestorProfilesIndividuals.prototype['ca_accredited_investor'] = undefined;

/**
 * The first name of the individual investor profile.
 * @member {String} first_name
 */
PatchInvestorProfilesIndividuals.prototype['first_name'] = undefined;

/**
 * The last name of the individual investor profile.
 * @member {String} last_name
 */
PatchInvestorProfilesIndividuals.prototype['last_name'] = undefined;

/**
 * The suffix of the individual investor profile.
 * @member {String} suffix
 */
PatchInvestorProfilesIndividuals.prototype['suffix'] = undefined;

/**
 * The date of birth of the investor profile.
 * @member {String} date_of_birth
 */
PatchInvestorProfilesIndividuals.prototype['date_of_birth'] = undefined;

/**
 * The taxpayer identification number of the investor profile.
 * @member {String} taxpayer_id
 */
PatchInvestorProfilesIndividuals.prototype['taxpayer_id'] = undefined;

/**
 * The phone number of the investor profile.
 * @member {String} phone_number
 */
PatchInvestorProfilesIndividuals.prototype['phone_number'] = undefined;

/**
 * The street address of the individual investor profile.
 * @member {String} street_address
 */
PatchInvestorProfilesIndividuals.prototype['street_address'] = undefined;

/**
 * The street address line 2 of the individual investor profile.
 * @member {String} unit2
 */
PatchInvestorProfilesIndividuals.prototype['unit2'] = undefined;

/**
 * The city of the individual investor profile.
 * @member {String} city
 */
PatchInvestorProfilesIndividuals.prototype['city'] = undefined;

/**
 * The region or state of the individual investor profile.
 * @member {String} region
 */
PatchInvestorProfilesIndividuals.prototype['region'] = undefined;

/**
 * The postal code or zipcode of the individual investor profile.
 * @member {String} postal_code
 */
PatchInvestorProfilesIndividuals.prototype['postal_code'] = undefined;

/**
 * The income of the individual investor profile
 * @member {Number} income
 */
PatchInvestorProfilesIndividuals.prototype['income'] = undefined;

/**
 * The net worth of the individual investor profile
 * @member {Number} net_worth
 */
PatchInvestorProfilesIndividuals.prototype['net_worth'] = undefined;

/**
 * The prior offering amount of the individual investor profile
 * @member {Number} reg_cf_prior_offerings_amount
 */
PatchInvestorProfilesIndividuals.prototype['reg_cf_prior_offerings_amount'] = undefined;
 ...
 * @readonly
 */
PatchInvestorProfilesIndividuals['UsAccreditedCategoryEnum'] = {
 ...
 * @readonly
 */
PatchInvestorProfilesIndividuals['CaAccreditedInvestorEnum'] = {
...
export default PatchInvestorProfilesIndividuals;
