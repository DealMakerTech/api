...
class PatchInvestorProfilesTrusts {
    /**
     * Constructs a new <code>PatchInvestorProfilesTrusts</code>.
     * Patch trust investor profile
     * @alias module:model/PatchInvestorProfilesTrusts
     */
    constructor() { 
        
        PatchInvestorProfilesTrusts.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PatchInvestorProfilesTrusts</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchInvestorProfilesTrusts} obj Optional instance to populate.
     * @return {module:model/PatchInvestorProfilesTrusts} The populated <code>PatchInvestorProfilesTrusts</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchInvestorProfilesTrusts();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchInvestorProfilesTrusts</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchInvestorProfilesTrusts</code>.
     */
 ...
 * @member {String} email
 */
PatchInvestorProfilesTrusts.prototype['email'] = undefined;

/**
 * The United States accredited investor information.
 * @member {module:model/PatchInvestorProfilesTrusts.UsAccreditedCategoryEnum} us_accredited_category
 */
PatchInvestorProfilesTrusts.prototype['us_accredited_category'] = undefined;

/**
 * The Canadian accredited investor information.
 * @member {module:model/PatchInvestorProfilesTrusts.CaAccreditedInvestorEnum} ca_accredited_investor
 */
PatchInvestorProfilesTrusts.prototype['ca_accredited_investor'] = undefined;

/**
 * The name of the trust.
 * @member {String} name
 */
PatchInvestorProfilesTrusts.prototype['name'] = undefined;

/**
 * The creation date of the trust.
 * @member {String} date
 */
PatchInvestorProfilesTrusts.prototype['date'] = undefined;

/**
 * The phone number of the trust.
 * @member {String} phone_number
 */
PatchInvestorProfilesTrusts.prototype['phone_number'] = undefined;

/**
 * Trust street address.
 * @member {String} street_address
 */
PatchInvestorProfilesTrusts.prototype['street_address'] = undefined;

/**
 * Trust street address line 2.
 * @member {String} unit2
 */
PatchInvestorProfilesTrusts.prototype['unit2'] = undefined;

/**
 * Trust city.
 * @member {String} city
 */
PatchInvestorProfilesTrusts.prototype['city'] = undefined;

/**
 * Trust region or state.
 * @member {String} region
 */
PatchInvestorProfilesTrusts.prototype['region'] = undefined;

/**
 * Trust postal code or zipcode.
 * @member {String} postal_code
 */
PatchInvestorProfilesTrusts.prototype['postal_code'] = undefined;

/**
 * The income of the Trust.
 * @member {Number} income
 */
PatchInvestorProfilesTrusts.prototype['income'] = undefined;

/**
 * The net worth of the Trust.
 * @member {Number} net_worth
 */
PatchInvestorProfilesTrusts.prototype['net_worth'] = undefined;
 ...
 * @readonly
 */
PatchInvestorProfilesTrusts['UsAccreditedCategoryEnum'] = {
 ...
 * @readonly
 */
PatchInvestorProfilesTrusts['CaAccreditedInvestorEnum'] = {
...
export default PatchInvestorProfilesTrusts;
