...
class PatchJointProfileRequest {
    /**
     * Constructs a new <code>PatchJointProfileRequest</code>.
     * @alias module:model/PatchJointProfileRequest
     */
    constructor() { 
        
        PatchJointProfileRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PatchJointProfileRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PatchJointProfileRequest} obj Optional instance to populate.
     * @return {module:model/PatchJointProfileRequest} The populated <code>PatchJointProfileRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchJointProfileRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchJointProfileRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchJointProfileRequest</code>.
     */
 ...
 * @member {module:model/PatchJointProfileRequest.UsAccreditedCategoryEnum} us_accredited_category
 */
PatchJointProfileRequest.prototype['us_accredited_category'] = undefined;

/**
 * The Canadian accredited investor information.
 * @member {module:model/PatchJointProfileRequest.CaAccreditedInvestorEnum} ca_accredited_investor
 */
PatchJointProfileRequest.prototype['ca_accredited_investor'] = undefined;

/**
 * The kind of joint investor.
 * @member {module:model/PatchJointProfileRequest.JointTypeEnum} joint_type
 */
PatchJointProfileRequest.prototype['joint_type'] = undefined;

/**
 * The first name of the investor profile.
 * @member {String} first_name
 */
PatchJointProfileRequest.prototype['first_name'] = undefined;

/**
 * The last name of the investor profile.
 * @member {String} last_name
 */
PatchJointProfileRequest.prototype['last_name'] = undefined;

/**
 * The suffix of the investor profile.
 * @member {String} suffix
 */
PatchJointProfileRequest.prototype['suffix'] = undefined;

/**
 * The country the investor profile.
 * @member {String} country
 */
PatchJointProfileRequest.prototype['country'] = undefined;

/**
 * The street address of the investor profile.
 * @member {String} street_address
 */
PatchJointProfileRequest.prototype['street_address'] = undefined;

/**
 * The street address line 2 of the investor profile.
 * @member {String} unit2
 */
PatchJointProfileRequest.prototype['unit2'] = undefined;

/**
 * The city of the investor profile.
 * @member {String} city
 */
PatchJointProfileRequest.prototype['city'] = undefined;

/**
 * The region or State of the investor profile.
 * @member {String} region
 */
PatchJointProfileRequest.prototype['region'] = undefined;

/**
 * The postal code or zipcode of the investor profile.
 * @member {String} postal_code
 */
PatchJointProfileRequest.prototype['postal_code'] = undefined;

/**
 * The date of birth of the investor profile.
 * @member {String} date_of_birth
 */
PatchJointProfileRequest.prototype['date_of_birth'] = undefined;

/**
 * The taxpayer identification number of the investor profile.
 * @member {String} taxpayer_id
 */
PatchJointProfileRequest.prototype['taxpayer_id'] = undefined;

/**
 * The phone number of the investor profile.
 * @member {String} phone_number
 */
PatchJointProfileRequest.prototype['phone_number'] = undefined;

/**
 * The income of the investor profile.
 * @member {Number} income
 */
PatchJointProfileRequest.prototype['income'] = undefined;

/**
 * The net worth of the investor profile.
 * @member {Number} net_worth
 */
PatchJointProfileRequest.prototype['net_worth'] = undefined;

/**
 * The prior offerings amount of the investor profile.
 * @member {Number} reg_cf_prior_offerings_amount
 */
PatchJointProfileRequest.prototype['reg_cf_prior_offerings_amount'] = undefined;

/**
 * The joint holder first name of the investor profile.
 * @member {String} joint_holder_first_name
 */
PatchJointProfileRequest.prototype['joint_holder_first_name'] = undefined;

/**
 * The joint holder last name of the investor profile.
 * @member {String} joint_holder_last_name
 */
PatchJointProfileRequest.prototype['joint_holder_last_name'] = undefined;

/**
 * The suffix of the individual investor profile.
 * @member {String} joint_holder_suffix
 */
PatchJointProfileRequest.prototype['joint_holder_suffix'] = undefined;

/**
 * The joint holder country of the investor profile.
 * @member {String} joint_holder_country
 */
PatchJointProfileRequest.prototype['joint_holder_country'] = undefined;

/**
 * The joint holder street address of the investor profile.
 * @member {String} joint_holder_street_address
 */
PatchJointProfileRequest.prototype['joint_holder_street_address'] = undefined;

/**
 * The Joint holder street address line 2 of the investor profile.
 * @member {String} joint_holder_unit2
 */
PatchJointProfileRequest.prototype['joint_holder_unit2'] = undefined;

/**
 * The Joint holder city of the investor profile.
 * @member {String} joint_holder_city
 */
PatchJointProfileRequest.prototype['joint_holder_city'] = undefined;

/**
 * The joint holder region or state of the investor profile.
 * @member {String} joint_holder_region
 */
PatchJointProfileRequest.prototype['joint_holder_region'] = undefined;

/**
 * The joint holder postal code or zipcode of the investor profile.
 * @member {String} joint_holder_postal_code
 */
PatchJointProfileRequest.prototype['joint_holder_postal_code'] = undefined;

/**
 * The joint holder date of birth of the investor profile.
 * @member {String} joint_holder_date_of_birth
 */
PatchJointProfileRequest.prototype['joint_holder_date_of_birth'] = undefined;

/**
 * The joint holder taxpayer identification number of the investor profile.
 * @member {String} joint_holder_taxpayer_id
 */
PatchJointProfileRequest.prototype['joint_holder_taxpayer_id'] = undefined;
 ...
 * @readonly
 */
PatchJointProfileRequest['UsAccreditedCategoryEnum'] = {
 ...
 * @readonly
 */
PatchJointProfileRequest['CaAccreditedInvestorEnum'] = {
 ...
 * @readonly
 */
PatchJointProfileRequest['JointTypeEnum'] = {
...
export default PatchJointProfileRequest;
