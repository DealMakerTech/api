...
import PostInvestorProfilesCorporationsBeneficialOwnersInner from './PostInvestorProfilesCorporationsBeneficialOwnersInner';
...
class PostInvestorProfilesCorporations {
    /**
     * Constructs a new <code>PostInvestorProfilesCorporations</code>.
     * Create new corporation investor profile.
     * @alias module:model/PostInvestorProfilesCorporations
     * @param email {String} User email which is associated with investor profile (required).
     */
    constructor(email) { 
        
        PostInvestorProfilesCorporations.initialize(this, email);
    }
    ...
    /**
     * Constructs a <code>PostInvestorProfilesCorporations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostInvestorProfilesCorporations} obj Optional instance to populate.
     * @return {module:model/PostInvestorProfilesCorporations} The populated <code>PostInvestorProfilesCorporations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostInvestorProfilesCorporations();
            ...
            if (data.hasOwnProperty('beneficial_owners')) {
                obj['beneficial_owners'] = ApiClient.convertToType(data['beneficial_owners'], [PostInvestorProfilesCorporationsBeneficialOwnersInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostInvestorProfilesCorporations</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostInvestorProfilesCorporations</code>.
     */
    static validateJSON(data) {
        ...
        if (data['beneficial_owners']) { // data not null
            ...
            for (const item of data['beneficial_owners']) {
                PostInvestorProfilesCorporationsBeneficialOwnersInner.validateJSON(item);
            };
        }
...
PostInvestorProfilesCorporations.RequiredProperties = ["email"];

/**
 * User email which is associated with investor profile (required).
 * @member {String} email
 */
PostInvestorProfilesCorporations.prototype['email'] = undefined;

/**
 * The United States accredited investor information.
 * @member {module:model/PostInvestorProfilesCorporations.UsAccreditedCategoryEnum} us_accredited_category
 */
PostInvestorProfilesCorporations.prototype['us_accredited_category'] = undefined;

/**
 * The Canadian accredited investor information.
 * @member {module:model/PostInvestorProfilesCorporations.CaAccreditedInvestorEnum} ca_accredited_investor
 */
PostInvestorProfilesCorporations.prototype['ca_accredited_investor'] = undefined;

/**
 * The name of the corporation (required).
 * @member {String} name
 */
PostInvestorProfilesCorporations.prototype['name'] = undefined;

/**
 * The street address of the corporation (required).
 * @member {String} street_address
 */
PostInvestorProfilesCorporations.prototype['street_address'] = undefined;

/**
 * The street address line 2 of the corporation.
 * @member {String} unit2
 */
PostInvestorProfilesCorporations.prototype['unit2'] = undefined;

/**
 * The city of the corporation (required).
 * @member {String} city
 */
PostInvestorProfilesCorporations.prototype['city'] = undefined;

/**
 * The region or state of the corporation (required).
 * @member {String} region
 */
PostInvestorProfilesCorporations.prototype['region'] = undefined;

/**
 * The postal code or zipcode of the corporation (required).
 * @member {String} postal_code
 */
PostInvestorProfilesCorporations.prototype['postal_code'] = undefined;

/**
 * The taxpayer identification number  of the corporation (required).
 * @member {String} business_number
 */
PostInvestorProfilesCorporations.prototype['business_number'] = undefined;

/**
 * The phone number o of the corporation (required).
 * @member {String} phone_number
 */
PostInvestorProfilesCorporations.prototype['phone_number'] = undefined;

/**
 * The income of the individual investor profile
 * @member {Number} income
 */
PostInvestorProfilesCorporations.prototype['income'] = undefined;

/**
 * The net worth of the individual investor profile
 * @member {Number} net_worth
 */
PostInvestorProfilesCorporations.prototype['net_worth'] = undefined;

/**
 * The prior offering amount of the individual investor profile
 * @member {Number} reg_cf_prior_offerings_amount
 */
PostInvestorProfilesCorporations.prototype['reg_cf_prior_offerings_amount'] = undefined;

/**
 * The first name of the signing officer (required).
 * @member {String} signing_officer_first_name
 */
PostInvestorProfilesCorporations.prototype['signing_officer_first_name'] = undefined;

/**
 * The last name of the signing officer (required).
 * @member {String} signing_officer_last_name
 */
PostInvestorProfilesCorporations.prototype['signing_officer_last_name'] = undefined;

/**
 * The title of the signing officer.
 * @member {String} signing_officer_title
 */
PostInvestorProfilesCorporations.prototype['signing_officer_title'] = undefined;

/**
 * The suffix of the signing officer.
 * @member {String} signing_officer_suffix
 */
PostInvestorProfilesCorporations.prototype['signing_officer_suffix'] = undefined;

/**
 * The street address of the signing officer (required).
 * @member {String} signing_officer_street_address
 */
PostInvestorProfilesCorporations.prototype['signing_officer_street_address'] = undefined;

/**
 * The street address line 2 of the signing officer.
 * @member {String} signing_officer_unit2
 */
PostInvestorProfilesCorporations.prototype['signing_officer_unit2'] = undefined;

/**
 * The city of the signing officer (required).
 * @member {String} signing_officer_city
 */
PostInvestorProfilesCorporations.prototype['signing_officer_city'] = undefined;

/**
 * The region or state of the signing officer (required).
 * @member {String} signing_officer_region
 */
PostInvestorProfilesCorporations.prototype['signing_officer_region'] = undefined;

/**
 * The postal code or zipcode of the signing officer (required).
 * @member {String} signing_officer_postal_code
 */
PostInvestorProfilesCorporations.prototype['signing_officer_postal_code'] = undefined;

/**
 * The date of birth of the signing officer (required).
 * @member {String} signing_officer_date_of_birth
 */
PostInvestorProfilesCorporations.prototype['signing_officer_date_of_birth'] = undefined;

/**
 * The taxpayer identification number of the signing officer (required).
 * @member {String} signing_officer_taxpayer_id
 */
PostInvestorProfilesCorporations.prototype['signing_officer_taxpayer_id'] = undefined;

/**
 * The phone number of the signing officer (required).
 * @member {String} signing_officer_phone_number
 */
PostInvestorProfilesCorporations.prototype['signing_officer_phone_number'] = undefined;

/**
 * @member {Array.<module:model/PostInvestorProfilesCorporationsBeneficialOwnersInner>} beneficial_owners
 */
PostInvestorProfilesCorporations.prototype['beneficial_owners'] = undefined;
 ...
 * @readonly
 */
PostInvestorProfilesCorporations['UsAccreditedCategoryEnum'] = {
 ...
 * @readonly
 */
PostInvestorProfilesCorporations['CaAccreditedInvestorEnum'] = {
...
export default PostInvestorProfilesCorporations;
