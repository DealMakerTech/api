...
/**
 * The PostInvestorProfilesIndividuals model module.
 * @module model/PostInvestorProfilesIndividuals
 * @version 0.98.1
 */
class PostInvestorProfilesIndividuals {
    /**
     * Constructs a new <code>PostInvestorProfilesIndividuals</code>.
     * Create new individual investor profile
     * @alias module:model/PostInvestorProfilesIndividuals
     * @param email {String} User email which is associated with individual investor profile.
     */
    constructor(email) { 
        
        PostInvestorProfilesIndividuals.initialize(this, email);
    }
    ...
    /**
     * Constructs a <code>PostInvestorProfilesIndividuals</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostInvestorProfilesIndividuals} obj Optional instance to populate.
     * @return {module:model/PostInvestorProfilesIndividuals} The populated <code>PostInvestorProfilesIndividuals</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostInvestorProfilesIndividuals();
    ...
    /**
     * Validates the JSON data with respect to <code>PostInvestorProfilesIndividuals</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostInvestorProfilesIndividuals</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostInvestorProfilesIndividuals.RequiredProperties) {
...
PostInvestorProfilesIndividuals.RequiredProperties = ["email"];

/**
 * User email which is associated with individual investor profile.
 * @member {String} email
 */
PostInvestorProfilesIndividuals.prototype['email'] = undefined;

/**
 * The United States accredited investor information.
 * @member {module:model/PostInvestorProfilesIndividuals.UsAccreditedCategoryEnum} us_accredited_category
 */
PostInvestorProfilesIndividuals.prototype['us_accredited_category'] = undefined;

/**
 * The Canadian accredited investor information.
 * @member {module:model/PostInvestorProfilesIndividuals.CaAccreditedInvestorEnum} ca_accredited_investor
 */
PostInvestorProfilesIndividuals.prototype['ca_accredited_investor'] = undefined;

/**
 * The first name of the individual investor profile (required).
 * @member {String} first_name
 */
PostInvestorProfilesIndividuals.prototype['first_name'] = undefined;

/**
 * The last name of the individual investor profile (required)
 * @member {String} last_name
 */
PostInvestorProfilesIndividuals.prototype['last_name'] = undefined;

/**
 * The suffix of the individual investor profile
 * @member {String} suffix
 */
PostInvestorProfilesIndividuals.prototype['suffix'] = undefined;

/**
 * The date of birth of the investor profile (required)
 * @member {String} date_of_birth
 */
PostInvestorProfilesIndividuals.prototype['date_of_birth'] = undefined;

/**
 * The taxpayer identification number of the investor profile (required)
 * @member {String} taxpayer_id
 */
PostInvestorProfilesIndividuals.prototype['taxpayer_id'] = undefined;

/**
 * The phone number of the investor profile (required)
 * @member {String} phone_number
 */
PostInvestorProfilesIndividuals.prototype['phone_number'] = undefined;

/**
 * The street address of the individual investor profile (required)
 * @member {String} street_address
 */
PostInvestorProfilesIndividuals.prototype['street_address'] = undefined;

/**
 * The street address line 2 of the individual investor profile
 * @member {String} unit2
 */
PostInvestorProfilesIndividuals.prototype['unit2'] = undefined;

/**
 * The city of the individual investor profile (required)
 * @member {String} city
 */
PostInvestorProfilesIndividuals.prototype['city'] = undefined;

/**
 * The region or state of the individual investor profile (required)
 * @member {String} region
 */
PostInvestorProfilesIndividuals.prototype['region'] = undefined;

/**
 * The postal code or zipcode of the individual investor profile (required)
 * @member {String} postal_code
 */
PostInvestorProfilesIndividuals.prototype['postal_code'] = undefined;

/**
 * The income of the individual investor profile
 * @member {Number} income
 */
PostInvestorProfilesIndividuals.prototype['income'] = undefined;

/**
 * The net worth of the individual investor profile
 * @member {Number} net_worth
 */
PostInvestorProfilesIndividuals.prototype['net_worth'] = undefined;

/**
 * The prior offering amount of the individual investor profile
 * @member {Number} reg_cf_prior_offerings_amount
 */
PostInvestorProfilesIndividuals.prototype['reg_cf_prior_offerings_amount'] = undefined;
 ...
 * @readonly
 */
PostInvestorProfilesIndividuals['UsAccreditedCategoryEnum'] = {
 ...
 * @readonly
 */
PostInvestorProfilesIndividuals['CaAccreditedInvestorEnum'] = {
...
export default PostInvestorProfilesIndividuals;
