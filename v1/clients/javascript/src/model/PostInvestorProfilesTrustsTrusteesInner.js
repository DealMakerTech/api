...
class PostInvestorProfilesTrustsTrusteesInner {
    /**
     * Constructs a new <code>PostInvestorProfilesTrustsTrusteesInner</code>.
     * @alias module:model/PostInvestorProfilesTrustsTrusteesInner
     */
    constructor() { 
        
        PostInvestorProfilesTrustsTrusteesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostInvestorProfilesTrustsTrusteesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostInvestorProfilesTrustsTrusteesInner} obj Optional instance to populate.
     * @return {module:model/PostInvestorProfilesTrustsTrusteesInner} The populated <code>PostInvestorProfilesTrustsTrusteesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostInvestorProfilesTrustsTrusteesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>PostInvestorProfilesTrustsTrusteesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostInvestorProfilesTrustsTrusteesInner</code>.
     */
 ...
 */
PostInvestorProfilesTrustsTrusteesInner.prototype['first_name'] = undefined;

/**
 * The list of last names for the trustees (required for trustee 1).
 * @member {String} last_name
 */
PostInvestorProfilesTrustsTrusteesInner.prototype['last_name'] = undefined;

/**
 * The list of suffixes for the trustees.
 * @member {String} suffix
 */
PostInvestorProfilesTrustsTrusteesInner.prototype['suffix'] = undefined;

/**
 * The list of street addresses for the trustees (required for trustee 1).
 * @member {String} street_address
 */
PostInvestorProfilesTrustsTrusteesInner.prototype['street_address'] = undefined;

/**
 * The list of street address line 2 for the trustees.
 * @member {String} unit2
 */
PostInvestorProfilesTrustsTrusteesInner.prototype['unit2'] = undefined;

/**
 * The list of cities for the trustees (required for trustee 1).
 * @member {String} city
 */
PostInvestorProfilesTrustsTrusteesInner.prototype['city'] = undefined;
 ...
 */
PostInvestorProfilesTrustsTrusteesInner.prototype['date_of_birth'] = undefined;
...
export default PostInvestorProfilesTrustsTrusteesInner;
