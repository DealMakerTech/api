...
class V1EntitiesBackgroundCheckSearch {
    /**
     * Constructs a new <code>V1EntitiesBackgroundCheckSearch</code>.
     * @alias module:model/V1EntitiesBackgroundCheckSearch
     */
    constructor() { 
        
        V1EntitiesBackgroundCheckSearch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1EntitiesBackgroundCheckSearch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1EntitiesBackgroundCheckSearch} obj Optional instance to populate.
     * @return {module:model/V1EntitiesBackgroundCheckSearch} The populated <code>V1EntitiesBackgroundCheckSearch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1EntitiesBackgroundCheckSearch();
...
/**
 * The background check search id.
 * @member {String} id
 */
V1EntitiesBackgroundCheckSearch.prototype['id'] = undefined;
...
export default V1EntitiesBackgroundCheckSearch;
