...
/**
 * The V1EntitiesDealInvestorMetrics model module.
 * @module model/V1EntitiesDealInvestorMetrics
 * @version 0.71.5
 */
class V1EntitiesDealInvestorMetrics {
    /**
     * Constructs a new <code>V1EntitiesDealInvestorMetrics</code>.
     * @alias module:model/V1EntitiesDealInvestorMetrics
     */
    constructor() { 
        
        V1EntitiesDealInvestorMetrics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1EntitiesDealInvestorMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1EntitiesDealInvestorMetrics} obj Optional instance to populate.
     * @return {module:model/V1EntitiesDealInvestorMetrics} The populated <code>V1EntitiesDealInvestorMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1EntitiesDealInvestorMetrics();
            ...
            if (data.hasOwnProperty('waiting')) {
                obj['waiting'] = ApiClient.convertToType(data['waiting'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>V1EntitiesDealInvestorMetrics</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1EntitiesDealInvestorMetrics</code>.
     */
 ...
 * @member {Number} total
 */
V1EntitiesDealInvestorMetrics.prototype['total'] = undefined;

/**
 * The total number of investors in the draft state.
 * @member {Number} draft
 */
V1EntitiesDealInvestorMetrics.prototype['draft'] = undefined;

/**
 * The total number of investors in the invited state.
 * @member {Number} invited
 */
V1EntitiesDealInvestorMetrics.prototype['invited'] = undefined;

/**
 * The total number of investors in the signed state.
 * @member {Number} signed
 */
V1EntitiesDealInvestorMetrics.prototype['signed'] = undefined;

/**
 * The total number of investors in the waiting state.
 * @member {Number} waiting
 */
V1EntitiesDealInvestorMetrics.prototype['waiting'] = undefined;

/**
 * The total number of investors in the accepted state.
 * @member {Number} accepted
 */
V1EntitiesDealInvestorMetrics.prototype['accepted'] = undefined;
...
export default V1EntitiesDealInvestorMetrics;
