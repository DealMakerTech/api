...
class V1EntitiesDealIssuer {
    /**
     * Constructs a new <code>V1EntitiesDealIssuer</code>.
     * @alias module:model/V1EntitiesDealIssuer
     */
    constructor() { 
        
        V1EntitiesDealIssuer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1EntitiesDealIssuer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1EntitiesDealIssuer} obj Optional instance to populate.
     * @return {module:model/V1EntitiesDealIssuer} The populated <code>V1EntitiesDealIssuer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1EntitiesDealIssuer();
 ...
 * @member {Number} id
 */
V1EntitiesDealIssuer.prototype['id'] = undefined;
...
export default V1EntitiesDealIssuer;
