...
class V1EntitiesDealsIncentivePlan {
    /**
     * Constructs a new <code>V1EntitiesDealsIncentivePlan</code>.
     * @alias module:model/V1EntitiesDealsIncentivePlan
     */
    constructor() { 
        
        V1EntitiesDealsIncentivePlan.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1EntitiesDealsIncentivePlan</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1EntitiesDealsIncentivePlan} obj Optional instance to populate.
     * @return {module:model/V1EntitiesDealsIncentivePlan} The populated <code>V1EntitiesDealsIncentivePlan</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1EntitiesDealsIncentivePlan();
    ...
    /**
     * Validates the JSON data with respect to <code>V1EntitiesDealsIncentivePlan</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1EntitiesDealsIncentivePlan</code>.
     */
 ...
 */
V1EntitiesDealsIncentivePlan.prototype['deal_id'] = undefined;

/**
 * The incentive plan type.
 * @member {module:model/V1EntitiesDealsIncentivePlan.PlanTypeEnum} plan_type
 */
V1EntitiesDealsIncentivePlan.prototype['plan_type'] = undefined;

/**
 * The incentive plan funded by offset.
 * @member {Number} funded_by_offset
 */
V1EntitiesDealsIncentivePlan.prototype['funded_by_offset'] = undefined;

/**
 * The incentive plan active date.
 * @member {Date} active_at
 */
V1EntitiesDealsIncentivePlan.prototype['active_at'] = undefined;

/**
 * The creation time.
 * @member {Date} created_at
 */
V1EntitiesDealsIncentivePlan.prototype['created_at'] = undefined;
 ...
 * @readonly
 */
V1EntitiesDealsIncentivePlan['PlanTypeEnum'] = {
...
export default V1EntitiesDealsIncentivePlan;
