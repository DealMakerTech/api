...
class V1EntitiesInvestorProfileFieldsBeneficiary {
    /**
     * Constructs a new <code>V1EntitiesInvestorProfileFieldsBeneficiary</code>.
     * @alias module:model/V1EntitiesInvestorProfileFieldsBeneficiary
     */
    constructor() { 
        
        V1EntitiesInvestorProfileFieldsBeneficiary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1EntitiesInvestorProfileFieldsBeneficiary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1EntitiesInvestorProfileFieldsBeneficiary} obj Optional instance to populate.
     * @return {module:model/V1EntitiesInvestorProfileFieldsBeneficiary} The populated <code>V1EntitiesInvestorProfileFieldsBeneficiary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1EntitiesInvestorProfileFieldsBeneficiary();
    ...
    /**
     * Validates the JSON data with respect to <code>V1EntitiesInvestorProfileFieldsBeneficiary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1EntitiesInvestorProfileFieldsBeneficiary</code>.
     */
 ...
 */
V1EntitiesInvestorProfileFieldsBeneficiary.prototype['first_name'] = undefined;

/**
 * Investor profile last name
 * @member {String} last_name
 */
V1EntitiesInvestorProfileFieldsBeneficiary.prototype['last_name'] = undefined;

/**
 * Investor profile suffix
 * @member {String} suffix
 */
V1EntitiesInvestorProfileFieldsBeneficiary.prototype['suffix'] = undefined;

/**
 * The date of birth
 * @member {String} date_of_birth
 */
V1EntitiesInvestorProfileFieldsBeneficiary.prototype['date_of_birth'] = undefined;

/**
 * The taxpayer identification number
 * @member {String} taxpayer_id
 */
V1EntitiesInvestorProfileFieldsBeneficiary.prototype['taxpayer_id'] = undefined;

/**
 * @member {module:model/V1EntitiesInvestorProfileAddress} address
 */
V1EntitiesInvestorProfileFieldsBeneficiary.prototype['address'] = undefined;

/**
 * Beneficiary account number
 * @member {String} account_number
 */
V1EntitiesInvestorProfileFieldsBeneficiary.prototype['account_number'] = undefined;

/**
 * Beneficiary phone number
 * @member {String} phone_number
 */
V1EntitiesInvestorProfileFieldsBeneficiary.prototype['phone_number'] = undefined;
...
export default V1EntitiesInvestorProfileFieldsBeneficiary;
