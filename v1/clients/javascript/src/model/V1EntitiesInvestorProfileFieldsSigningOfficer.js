...
class V1EntitiesInvestorProfileFieldsSigningOfficer {
    /**
     * Constructs a new <code>V1EntitiesInvestorProfileFieldsSigningOfficer</code>.
     * @alias module:model/V1EntitiesInvestorProfileFieldsSigningOfficer
     */
    constructor() { 
        
        V1EntitiesInvestorProfileFieldsSigningOfficer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1EntitiesInvestorProfileFieldsSigningOfficer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1EntitiesInvestorProfileFieldsSigningOfficer} obj Optional instance to populate.
     * @return {module:model/V1EntitiesInvestorProfileFieldsSigningOfficer} The populated <code>V1EntitiesInvestorProfileFieldsSigningOfficer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1EntitiesInvestorProfileFieldsSigningOfficer();
    ...
    /**
     * Validates the JSON data with respect to <code>V1EntitiesInvestorProfileFieldsSigningOfficer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1EntitiesInvestorProfileFieldsSigningOfficer</code>.
     */
 ...
 */
V1EntitiesInvestorProfileFieldsSigningOfficer.prototype['first_name'] = undefined;

/**
 * Investor profile last name
 * @member {String} last_name
 */
V1EntitiesInvestorProfileFieldsSigningOfficer.prototype['last_name'] = undefined;

/**
 * Investor profile suffix
 * @member {String} suffix
 */
V1EntitiesInvestorProfileFieldsSigningOfficer.prototype['suffix'] = undefined;

/**
 * The date of birth
 * @member {String} date_of_birth
 */
V1EntitiesInvestorProfileFieldsSigningOfficer.prototype['date_of_birth'] = undefined;

/**
 * The taxpayer identification number
 * @member {String} taxpayer_id
 */
V1EntitiesInvestorProfileFieldsSigningOfficer.prototype['taxpayer_id'] = undefined;
 ...
 */
V1EntitiesInvestorProfileFieldsSigningOfficer.prototype['phone_number'] = undefined;
...
export default V1EntitiesInvestorProfileFieldsSigningOfficer;
