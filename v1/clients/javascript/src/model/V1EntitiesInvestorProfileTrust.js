...
class V1EntitiesInvestorProfileTrust {
    /**
     * Constructs a new <code>V1EntitiesInvestorProfileTrust</code>.
     * V1_Entities_InvestorProfile_Trust model
     * @alias module:model/V1EntitiesInvestorProfileTrust
     */
    constructor() { 
        
        V1EntitiesInvestorProfileTrust.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1EntitiesInvestorProfileTrust</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1EntitiesInvestorProfileTrust} obj Optional instance to populate.
     * @return {module:model/V1EntitiesInvestorProfileTrust} The populated <code>V1EntitiesInvestorProfileTrust</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1EntitiesInvestorProfileTrust();
            ...
            if (data.hasOwnProperty('trust_holder')) {
    ...
    /**
     * Validates the JSON data with respect to <code>V1EntitiesInvestorProfileTrust</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1EntitiesInvestorProfileTrust</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `trust_holder`
        if (data['trust_holder']) { // data not null
          V1EntitiesInvestorProfileFieldsTrust.validateJSON(data['trust_holder']);
        }
 ...
 * @member {Number} id
 */
V1EntitiesInvestorProfileTrust.prototype['id'] = undefined;

/**
 * User id
 * @member {Number} user_id
 */
V1EntitiesInvestorProfileTrust.prototype['user_id'] = undefined;

/**
 * User email
 * @member {String} email
 */
V1EntitiesInvestorProfileTrust.prototype['email'] = undefined;

/**
 * Investor Profile type
 * @member {module:model/V1EntitiesInvestorProfileTrust.TypeEnum} type
 */
V1EntitiesInvestorProfileTrust.prototype['type'] = undefined;

/**
 * The United States accredited investor information
 * @member {String} us_accredited_category
 */
V1EntitiesInvestorProfileTrust.prototype['us_accredited_category'] = undefined;

/**
 * The Canadian accredited investor information
 * @member {String} ca_accredited_investor
 */
V1EntitiesInvestorProfileTrust.prototype['ca_accredited_investor'] = undefined;

/**
 * To check if the profile is complete or not
 * @member {Boolean} complete
 */
V1EntitiesInvestorProfileTrust.prototype['complete'] = undefined;

/**
 * Type of the investor profile owner
 * @member {String} owner_type
 */
V1EntitiesInvestorProfileTrust.prototype['owner_type'] = undefined;

/**
 * @member {module:model/V1EntitiesInvestorProfileOwner} owner
 */
V1EntitiesInvestorProfileTrust.prototype['owner'] = undefined;

/**
 * @member {module:model/V1EntitiesInvestorProfileFieldsTrust} trust_holder
 */
 ...
 * @readonly
 */
V1EntitiesInvestorProfileTrust['TypeEnum'] = {
...
export default V1EntitiesInvestorProfileTrust;
