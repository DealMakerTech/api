...
/**
 * The V1EntitiesInvestorUser model module.
 * @module model/V1EntitiesInvestorUser
 * @version 0.0.1
 */
class V1EntitiesInvestorUser {
    /**
     * Constructs a new <code>V1EntitiesInvestorUser</code>.
     * @alias module:model/V1EntitiesInvestorUser
     */
    constructor() { 
        
        V1EntitiesInvestorUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1EntitiesInvestorUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1EntitiesInvestorUser} obj Optional instance to populate.
     * @return {module:model/V1EntitiesInvestorUser} The populated <code>V1EntitiesInvestorUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1EntitiesInvestorUser();
 ...
 * @member {Number} id
 */
V1EntitiesInvestorUser.prototype['id'] = undefined;

/**
 * Investor user email address.
 * @member {String} email
 */
V1EntitiesInvestorUser.prototype['email'] = undefined;
...
export default V1EntitiesInvestorUser;
