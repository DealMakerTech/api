...
(function(root, factory) {
  ...
  describe('DefaultApi', function() {
    ...
    describe('getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData', function() {
      it('should call getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData successfully', function(done) {
        //uncomment below and update the code to test getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData
        //instance.getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getDealsIdSummary', function() {
      it('should call getDealsIdSummary successfully', function(done) {
        ...
        //instance.getDealsIdSummary(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getWebhooksDealId', function() {
      it('should call getWebhooksDealId successfully', function(done) {
        //uncomment below and update the code to test getWebhooksDealId
        //instance.getWebhooksDealId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getWebhooksDealsSearch', function() {
      it('should call getWebhooksDealsSearch successfully', function(done) {
        //uncomment below and update the code to test getWebhooksDealsSearch
        //instance.getWebhooksDealsSearch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getWebhooksSecurityToken', function() {
      it('should call getWebhooksSecurityToken successfully', function(done) {
        //uncomment below and update the code to test getWebhooksSecurityToken
        //instance.getWebhooksSecurityToken(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
