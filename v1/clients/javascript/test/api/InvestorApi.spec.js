  ...
  describe('InvestorApi', function() {
    ...
    describe('getInvestor', function() {
      it('should call getInvestor successfully', function(done) {
        ...
        //instance.getInvestor(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listInvestors', function() {
      it('should call listInvestors successfully', function(done) {
        ...
        //instance.listInvestors(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('patchInvestor', function() {
      it('should call patchInvestor successfully', function(done) {
        //uncomment below and update the code to test patchInvestor
        //instance.patchInvestor(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateInvestor', function() {
      it('should call updateInvestor successfully', function(done) {
        ...
        //instance.updateInvestor(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
