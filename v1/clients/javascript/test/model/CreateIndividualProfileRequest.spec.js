...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateIndividualProfileRequest();
  });
  ...
  describe('CreateIndividualProfileRequest', function() {
    it('should create an instance of CreateIndividualProfileRequest', function() {
      // uncomment below and update the code to test CreateIndividualProfileRequest
      //var instance = new Api.CreateIndividualProfileRequest();
      //expect(instance).to.be.a(Api.CreateIndividualProfileRequest);
    });
