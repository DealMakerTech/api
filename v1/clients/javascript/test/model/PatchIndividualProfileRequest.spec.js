...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PatchIndividualProfileRequest();
  });
  ...
  describe('PatchIndividualProfileRequest', function() {
    it('should create an instance of PatchIndividualProfileRequest', function() {
      // uncomment below and update the code to test PatchIndividualProfileRequest
      //var instance = new Api.PatchIndividualProfileRequest();
      //expect(instance).to.be.a(Api.PatchIndividualProfileRequest);
    });
