...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PatchInvestorProfilesCorporationsBeneficialOwnersInner();
  });
  ...
  describe('PatchInvestorProfilesCorporationsBeneficialOwnersInner', function() {
    it('should create an instance of PatchInvestorProfilesCorporationsBeneficialOwnersInner', function() {
      // uncomment below and update the code to test PatchInvestorProfilesCorporationsBeneficialOwnersInner
      //var instance = new Api.PatchInvestorProfilesCorporationsBeneficialOwnersInner();
      //expect(instance).to.be.a(Api.PatchInvestorProfilesCorporationsBeneficialOwnersInner);
    });
    ...
    it('should have the property _delete (base name: "_delete")', function() {
