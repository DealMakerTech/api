...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PatchInvestorProfilesTrusts();
  });
  ...
  describe('PatchInvestorProfilesTrusts', function() {
    it('should create an instance of PatchInvestorProfilesTrusts', function() {
      // uncomment below and update the code to test PatchInvestorProfilesTrusts
      //var instance = new Api.PatchInvestorProfilesTrusts();
      //expect(instance).to.be.a(Api.PatchInvestorProfilesTrusts);
    });
