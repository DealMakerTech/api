...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PatchTrustProfileRequest();
  });
  ...
  describe('PatchTrustProfileRequest', function() {
    it('should create an instance of PatchTrustProfileRequest', function() {
      // uncomment below and update the code to test PatchTrustProfileRequest
      //var instance = new Api.PatchTrustProfileRequest();
      //expect(instance).to.be.a(Api.PatchTrustProfileRequest);
    });
    ...
    it('should have the property trusteeCountry (base name: "trustee_country")', function() {
      // uncomment below and update the code to test the property trusteeCountry
      //var instance = new Api.PatchTrustProfileRequest();
      //expect(instance).to.be();
    });
