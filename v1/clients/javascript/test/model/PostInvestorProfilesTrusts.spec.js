...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PostInvestorProfilesTrusts();
  });
  ...
  describe('PostInvestorProfilesTrusts', function() {
    it('should create an instance of PostInvestorProfilesTrusts', function() {
      // uncomment below and update the code to test PostInvestorProfilesTrusts
      //var instance = new Api.PostInvestorProfilesTrusts();
      //expect(instance).to.be.a(Api.PostInvestorProfilesTrusts);
    });
