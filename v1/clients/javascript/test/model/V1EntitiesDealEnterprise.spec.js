...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dealmakerapi.V1EntitiesDealEnterprise();
  });
  ...
  describe('V1EntitiesDealEnterprise', function() {
    it('should create an instance of V1EntitiesDealEnterprise', function() {
      // uncomment below and update the code to test V1EntitiesDealEnterprise
      //var instance = new Dealmakerapi.V1EntitiesDealEnterprise();
      //expect(instance).to.be.a(Dealmakerapi.V1EntitiesDealEnterprise);
    });
