...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dealmakerapi.V1EntitiesDealFundingMetrics();
  });
  ...
  describe('V1EntitiesDealFundingMetrics', function() {
    it('should create an instance of V1EntitiesDealFundingMetrics', function() {
      // uncomment below and update the code to test V1EntitiesDealFundingMetrics
      //var instance = new Dealmakerapi.V1EntitiesDealFundingMetrics();
      //expect(instance).to.be.a(Dealmakerapi.V1EntitiesDealFundingMetrics);
    });

    it('should have the property amountSubscribed (base name: "amount_subscribed")', function() {
      // uncomment below and update the code to test the property amountSubscribed
      //var instance = new Dealmakerapi.V1EntitiesDealFundingMetrics();
      //expect(instance).to.be();
    });

    it('should have the property securitiesSubscribed (base name: "securities_subscribed")', function() {
      // uncomment below and update the code to test the property securitiesSubscribed
      //var instance = new Dealmakerapi.V1EntitiesDealFundingMetrics();
      //expect(instance).to.be();
    });
    ...
    it('should have the property securitiesAllocated (base name: "securities_allocated")', function() {
      // uncomment below and update the code to test the property securitiesAllocated
      //var instance = new Dealmakerapi.V1EntitiesDealFundingMetrics();
      //expect(instance).to.be();
    });

    it('should have the property amountAccepted (base name: "amount_accepted")', function() {
      // uncomment below and update the code to test the property amountAccepted
      //var instance = new Dealmakerapi.V1EntitiesDealFundingMetrics();
      //expect(instance).to.be();
    });

    it('should have the property securitiesAccepted (base name: "securities_accepted")', function() {
      // uncomment below and update the code to test the property securitiesAccepted
      //var instance = new Dealmakerapi.V1EntitiesDealFundingMetrics();
      //expect(instance).to.be();
    });
