...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dealmakerapi.V1EntitiesDealInvestorMetrics();
  });
  ...
  describe('V1EntitiesDealInvestorMetrics', function() {
    it('should create an instance of V1EntitiesDealInvestorMetrics', function() {
      // uncomment below and update the code to test V1EntitiesDealInvestorMetrics
      //var instance = new Dealmakerapi.V1EntitiesDealInvestorMetrics();
      //expect(instance).to.be.a(Dealmakerapi.V1EntitiesDealInvestorMetrics);
    });
