...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dealmakerapi.V1EntitiesDealIssuer();
  });
  ...
  describe('V1EntitiesDealIssuer', function() {
    it('should create an instance of V1EntitiesDealIssuer', function() {
      // uncomment below and update the code to test V1EntitiesDealIssuer
      //var instance = new Dealmakerapi.V1EntitiesDealIssuer();
      //expect(instance).to.be.a(Dealmakerapi.V1EntitiesDealIssuer);
    });
