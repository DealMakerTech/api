...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.V1EntitiesInvestorProfileCorporation();
  });
  ...
  describe('V1EntitiesInvestorProfileCorporation', function() {
    it('should create an instance of V1EntitiesInvestorProfileCorporation', function() {
      // uncomment below and update the code to test V1EntitiesInvestorProfileCorporation
      //var instance = new Api.V1EntitiesInvestorProfileCorporation();
      //expect(instance).to.be.a(Api.V1EntitiesInvestorProfileCorporation);
    });
    ...
    it('should have the property signingOfficer (base name: "signing_officer")', function() {
      // uncomment below and update the code to test the property signingOfficer
      //var instance = new Api.V1EntitiesInvestorProfileCorporation();
      //expect(instance).to.be();
    });
