...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dealmakerapi.V1EntitiesInvestorProfileIndividual();
  });
  ...
  describe('V1EntitiesInvestorProfileIndividual', function() {
    it('should create an instance of V1EntitiesInvestorProfileIndividual', function() {
      // uncomment below and update the code to test V1EntitiesInvestorProfileIndividual
      //var instance = new Dealmakerapi.V1EntitiesInvestorProfileIndividual();
      //expect(instance).to.be.a(Dealmakerapi.V1EntitiesInvestorProfileIndividual);
    });
