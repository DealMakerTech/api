...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.V1EntitiesInvestorProfileJoint();
  });
  ...
  describe('V1EntitiesInvestorProfileJoint', function() {
    it('should create an instance of V1EntitiesInvestorProfileJoint', function() {
      // uncomment below and update the code to test V1EntitiesInvestorProfileJoint
      //var instance = new Api.V1EntitiesInvestorProfileJoint();
      //expect(instance).to.be.a(Api.V1EntitiesInvestorProfileJoint);
    });
    ...
    it('should have the property primaryHolder (base name: "primary_holder")', function() {
      // uncomment below and update the code to test the property primaryHolder
      //var instance = new Api.V1EntitiesInvestorProfileJoint();
      //expect(instance).to.be();
    });

    it('should have the property jointHolder (base name: "joint_holder")', function() {
      // uncomment below and update the code to test the property jointHolder
      //var instance = new Api.V1EntitiesInvestorProfileJoint();
      //expect(instance).to.be();
    });
