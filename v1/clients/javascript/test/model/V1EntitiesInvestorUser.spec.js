...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dealmakerapi.V1EntitiesInvestorUser();
  });
  ...
  describe('V1EntitiesInvestorUser', function() {
    it('should create an instance of V1EntitiesInvestorUser', function() {
      // uncomment below and update the code to test V1EntitiesInvestorUser
      //var instance = new Dealmakerapi.V1EntitiesInvestorUser();
      //expect(instance).to.be.a(Dealmakerapi.V1EntitiesInvestorUser);
    });
