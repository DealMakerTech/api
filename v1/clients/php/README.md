...
*CompanyApi* | [**getBulkUploadDetails**](docs/Api/CompanyApi.md#getbulkuploaddetails) | **GET** /companies/{company_id}/documents/bulk_uploads/{bulk_upload_id}/details | Return full list of bulk upload details order by status desc and id asc
*CompanyApi* | [**getBulkUploadDetailsByStatus**](docs/Api/CompanyApi.md#getbulkuploaddetailsbystatus) | **GET** /companies/{company_id}/documents/bulk_uploads/{bulk_upload_id}/details/group_by_status | Return bulk upload details grouped by status
