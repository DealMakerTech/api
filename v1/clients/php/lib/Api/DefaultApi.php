...
class DefaultApi
{
    ...
    /**
     * Operation getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData
     *
     * Get payout account data
     *
     * @param  int $deal_id deal_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData'] to see the possible values for this operation
     *
     * @throws \DealMaker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DealMaker\Model\V1EntitiesPaymentsSelfServeOnboardingPayoutAccountDetailsData
     */
    public function getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData($deal_id, string $contentType = self::contentTypes['getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData'][0])
    {
        list($response) = $this->getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataWithHttpInfo($deal_id, $contentType);
        return $response;
    }

    /**
     * Operation getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataWithHttpInfo
     *
     * Get payout account data
     *
     * @param  int $deal_id (required)
     ...
     * @throws \DealMaker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DealMaker\Model\V1EntitiesPaymentsSelfServeOnboardingPayoutAccountDetailsData, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataWithHttpInfo($deal_id, string $contentType = self::contentTypes['getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData'][0])
    {
        $request = $this->getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataRequest($deal_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DealMaker\Model\V1EntitiesPaymentsSelfServeOnboardingPayoutAccountDetailsData' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DealMaker\Model\V1EntitiesPaymentsSelfServeOnboardingPayoutAccountDetailsData' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DealMaker\Model\V1EntitiesPaymentsSelfServeOnboardingPayoutAccountDetailsData', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\DealMaker\Model\V1EntitiesPaymentsSelfServeOnboardingPayoutAccountDetailsData';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DealMaker\Model\V1EntitiesPaymentsSelfServeOnboardingPayoutAccountDetailsData',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataAsync
     *
     * Get payout account data
     *
     * @param  int $deal_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataAsync($deal_id, string $contentType = self::contentTypes['getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData'][0])
    {
        return $this->getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataAsyncWithHttpInfo($deal_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataAsyncWithHttpInfo
     *
     * Get payout account data
     *
     * @param  int $deal_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataAsyncWithHttpInfo($deal_id, string $contentType = self::contentTypes['getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData'][0])
    {
        $returnType = '\DealMaker\Model\V1EntitiesPaymentsSelfServeOnboardingPayoutAccountDetailsData';
        $request = $this->getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataRequest($deal_id, $contentType);
    ...
    /**
     * Create request for operation 'getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData'
     *
     * @param  int $deal_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsDataRequest($deal_id, string $contentType = self::contentTypes['getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData'][0])
    {

        // verify the required parameter 'deal_id' is set
        if ($deal_id === null || (is_array($deal_id) && count($deal_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $deal_id when calling getDealsDealIdPaymentOnboardingQuestionnairePayoutAccountDetailsData'
            );
        }


        $resourcePath = '/deals/{deal_id}/payment_onboarding/questionnaire/payout_account_details/data';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getDealsIdPlatformEmailsDomain
     *
     * Get the email domain settings for the deal
     *
     * @param  int $id The deal id. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDealsIdPlatformEmailsDomain'] to see the possible values for this operation
     *
     * @throws \DealMaker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DealMaker\Model\V1EntitiesDealsPlatformEmailsDomainSettings
     */
    public function getDealsIdPlatformEmailsDomain($id, string $contentType = self::contentTypes['getDealsIdPlatformEmailsDomain'][0])
    {
        list($response) = $this->getDealsIdPlatformEmailsDomainWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation getDealsIdPlatformEmailsDomainWithHttpInfo
     *
     * Get the email domain settings for the deal
     *
     * @param  int $id The deal id. (required)
     ...
     * @throws \DealMaker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DealMaker\Model\V1EntitiesDealsPlatformEmailsDomainSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDealsIdPlatformEmailsDomainWithHttpInfo($id, string $contentType = self::contentTypes['getDealsIdPlatformEmailsDomain'][0])
    {
        $request = $this->getDealsIdPlatformEmailsDomainRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DealMaker\Model\V1EntitiesDealsPlatformEmailsDomainSettings' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DealMaker\Model\V1EntitiesDealsPlatformEmailsDomainSettings' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DealMaker\Model\V1EntitiesDealsPlatformEmailsDomainSettings', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\DealMaker\Model\V1EntitiesDealsPlatformEmailsDomainSettings';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DealMaker\Model\V1EntitiesDealsPlatformEmailsDomainSettings',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getDealsIdPlatformEmailsDomainAsync
     *
     * Get the email domain settings for the deal
     *
     * @param  int $id The deal id. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDealsIdPlatformEmailsDomainAsync($id, string $contentType = self::contentTypes['getDealsIdPlatformEmailsDomain'][0])
    {
        return $this->getDealsIdPlatformEmailsDomainAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDealsIdPlatformEmailsDomainAsyncWithHttpInfo
     *
     * Get the email domain settings for the deal
     *
     * @param  int $id The deal id. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDealsIdPlatformEmailsDomainAsyncWithHttpInfo($id, string $contentType = self::contentTypes['getDealsIdPlatformEmailsDomain'][0])
    {
        $returnType = '\DealMaker\Model\V1EntitiesDealsPlatformEmailsDomainSettings';
        $request = $this->getDealsIdPlatformEmailsDomainRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'getDealsIdPlatformEmailsDomain'
     *
     * @param  int $id The deal id. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDealsIdPlatformEmailsDomain'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDealsIdPlatformEmailsDomainRequest($id, string $contentType = self::contentTypes['getDealsIdPlatformEmailsDomain'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getDealsIdPlatformEmailsDomain'
            );
        }
    ...
    public function getDealsIdProgressPageWithHttpInfo($id, string $contentType = self::contentTypes['getDealsIdProgressPage'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DealMaker\Model\V1EntitiesDealsProgress' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DealMaker\Model\V1EntitiesDealsProgress' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DealMaker\Model\V1EntitiesDealsProgress', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DealMaker\Model\V1EntitiesDealsProgress',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getDealsIdProgressPageSummary
     *
     * Get the deal progress summary
     *
     * @param  int $id The deal id. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDealsIdProgressPageSummary'] to see the possible values for this operation
     *
     * @throws \DealMaker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DealMaker\Model\V1EntitiesDealsProgressPageSummary
     */
    public function getDealsIdProgressPageSummary($id, string $contentType = self::contentTypes['getDealsIdProgressPageSummary'][0])
    {
        list($response) = $this->getDealsIdProgressPageSummaryWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation getDealsIdProgressPageSummaryWithHttpInfo
     *
     * Get the deal progress summary
     *
     * @param  int $id The deal id. (required)
     ...
     * @throws \DealMaker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DealMaker\Model\V1EntitiesDealsProgressPageSummary, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDealsIdProgressPageSummaryWithHttpInfo($id, string $contentType = self::contentTypes['getDealsIdProgressPageSummary'][0])
    {
        $request = $this->getDealsIdProgressPageSummaryRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DealMaker\Model\V1EntitiesDealsProgressPageSummary' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DealMaker\Model\V1EntitiesDealsProgressPageSummary' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DealMaker\Model\V1EntitiesDealsProgressPageSummary', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\DealMaker\Model\V1EntitiesDealsProgressPageSummary';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DealMaker\Model\V1EntitiesDealsProgressPageSummary',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getDealsIdProgressPageSummaryAsync
     *
     * Get the deal progress summary
     *
     * @param  int $id The deal id. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDealsIdProgressPageSummaryAsync($id, string $contentType = self::contentTypes['getDealsIdProgressPageSummary'][0])
    {
        return $this->getDealsIdProgressPageSummaryAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDealsIdProgressPageSummaryAsyncWithHttpInfo
     *
     * Get the deal progress summary
     *
     * @param  int $id The deal id. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDealsIdProgressPageSummaryAsyncWithHttpInfo($id, string $contentType = self::contentTypes['getDealsIdProgressPageSummary'][0])
    {
        $returnType = '\DealMaker\Model\V1EntitiesDealsProgressPageSummary';
        $request = $this->getDealsIdProgressPageSummaryRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'getDealsIdProgressPageSummary'
     *
     * @param  int $id The deal id. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDealsIdProgressPageSummary'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDealsIdProgressPageSummaryRequest($id, string $contentType = self::contentTypes['getDealsIdProgressPageSummary'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getDealsIdProgressPageSummary'
            );
        }


        $resourcePath = '/deals/{id}/progress_page/summary';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getDealsIdSummary
     *
     * Get Deal Overview
     *
     * @param  int $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDealsIdSummary'] to see the possible values for this operation
     *
     * @throws \DealMaker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function getDealsIdSummary($id, string $contentType = self::contentTypes['getDealsIdSummary'][0])
    {
        $this->getDealsIdSummaryWithHttpInfo($id, $contentType);
    }

    /**
     * Operation getDealsIdSummaryWithHttpInfo
     *
     * Get Deal Overview
     *
     * @param  int $id (required)
     ...
     */
    public function getDealsIdSummaryWithHttpInfo($id, string $contentType = self::contentTypes['getDealsIdSummary'][0])
    {
        $request = $this->getDealsIdSummaryRequest($id, $contentType);
    ...
    /**
     * Operation getDealsIdSummaryAsync
     *
     * Get Deal Overview
     *
     * @param  int $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDealsIdSummaryAsync($id, string $contentType = self::contentTypes['getDealsIdSummary'][0])
    {
        return $this->getDealsIdSummaryAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDealsIdSummaryAsyncWithHttpInfo
     *
     * Get Deal Overview
     *
     * @param  int $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDealsIdSummaryAsyncWithHttpInfo($id, string $contentType = self::contentTypes['getDealsIdSummary'][0])
    {
        $returnType = '';
        $request = $this->getDealsIdSummaryRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'getDealsIdSummary'
     *
     * @param  int $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDealsIdSummary'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDealsIdSummaryRequest($id, string $contentType = self::contentTypes['getDealsIdSummary'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getDealsIdSummary'
            );
        }


        $resourcePath = '/deals/{id}/summary';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postInvestorsInvestorIdDeleteInvestmentProcess
     *
     * Delete investment
     *
     * @param  int $investor_id investor_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postInvestorsInvestorIdDeleteInvestmentProcess'] to see the possible values for this operation
     *
     * @throws \DealMaker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postInvestorsInvestorIdDeleteInvestmentProcess($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdDeleteInvestmentProcess'][0])
    {
        $this->postInvestorsInvestorIdDeleteInvestmentProcessWithHttpInfo($investor_id, $contentType);
    }

    /**
     * Operation postInvestorsInvestorIdDeleteInvestmentProcessWithHttpInfo
     *
     * Delete investment
     *
     * @param  int $investor_id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postInvestorsInvestorIdDeleteInvestmentProcessWithHttpInfo($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdDeleteInvestmentProcess'][0])
    {
        $request = $this->postInvestorsInvestorIdDeleteInvestmentProcessRequest($investor_id, $contentType);
    ...
    /**
     * Operation postInvestorsInvestorIdDeleteInvestmentProcessAsync
     *
     * Delete investment
     *
     * @param  int $investor_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postInvestorsInvestorIdDeleteInvestmentProcessAsync($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdDeleteInvestmentProcess'][0])
    {
        return $this->postInvestorsInvestorIdDeleteInvestmentProcessAsyncWithHttpInfo($investor_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postInvestorsInvestorIdDeleteInvestmentProcessAsyncWithHttpInfo
     *
     * Delete investment
     *
     * @param  int $investor_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postInvestorsInvestorIdDeleteInvestmentProcessAsyncWithHttpInfo($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdDeleteInvestmentProcess'][0])
    {
        $returnType = '';
        $request = $this->postInvestorsInvestorIdDeleteInvestmentProcessRequest($investor_id, $contentType);
    ...
    /**
     * Create request for operation 'postInvestorsInvestorIdDeleteInvestmentProcess'
     *
     * @param  int $investor_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postInvestorsInvestorIdDeleteInvestmentProcess'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postInvestorsInvestorIdDeleteInvestmentProcessRequest($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdDeleteInvestmentProcess'][0])
    {

        // verify the required parameter 'investor_id' is set
        if ($investor_id === null || (is_array($investor_id) && count($investor_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $investor_id when calling postInvestorsInvestorIdDeleteInvestmentProcess'
            );
        }


        $resourcePath = '/investors/{investor_id}/delete_investment/process';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postInvestorsInvestorIdTransactionsRequestRefundProcess
     *
     * Request refund for investor transactions
     *
     * @param  int $investor_id investor_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postInvestorsInvestorIdTransactionsRequestRefundProcess'] to see the possible values for this operation
     *
     * @throws \DealMaker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postInvestorsInvestorIdTransactionsRequestRefundProcess($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdTransactionsRequestRefundProcess'][0])
    {
        $this->postInvestorsInvestorIdTransactionsRequestRefundProcessWithHttpInfo($investor_id, $contentType);
    }

    /**
     * Operation postInvestorsInvestorIdTransactionsRequestRefundProcessWithHttpInfo
     *
     * Request refund for investor transactions
     *
     * @param  int $investor_id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postInvestorsInvestorIdTransactionsRequestRefundProcessWithHttpInfo($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdTransactionsRequestRefundProcess'][0])
    {
        $request = $this->postInvestorsInvestorIdTransactionsRequestRefundProcessRequest($investor_id, $contentType);
    ...
    /**
     * Operation postInvestorsInvestorIdTransactionsRequestRefundProcessAsync
     *
     * Request refund for investor transactions
     *
     * @param  int $investor_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postInvestorsInvestorIdTransactionsRequestRefundProcessAsync($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdTransactionsRequestRefundProcess'][0])
    {
        return $this->postInvestorsInvestorIdTransactionsRequestRefundProcessAsyncWithHttpInfo($investor_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postInvestorsInvestorIdTransactionsRequestRefundProcessAsyncWithHttpInfo
     *
     * Request refund for investor transactions
     *
     * @param  int $investor_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postInvestorsInvestorIdTransactionsRequestRefundProcessAsyncWithHttpInfo($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdTransactionsRequestRefundProcess'][0])
    {
        $returnType = '';
        $request = $this->postInvestorsInvestorIdTransactionsRequestRefundProcessRequest($investor_id, $contentType);
    ...
    /**
     * Create request for operation 'postInvestorsInvestorIdTransactionsRequestRefundProcess'
     *
     * @param  int $investor_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postInvestorsInvestorIdTransactionsRequestRefundProcess'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postInvestorsInvestorIdTransactionsRequestRefundProcessRequest($investor_id, string $contentType = self::contentTypes['postInvestorsInvestorIdTransactionsRequestRefundProcess'][0])
    {

        // verify the required parameter 'investor_id' is set
        if ($investor_id === null || (is_array($investor_id) && count($investor_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $investor_id when calling postInvestorsInvestorIdTransactionsRequestRefundProcess'
            );
        }


        $resourcePath = '/investors/{investor_id}/transactions/request_refund/process';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
