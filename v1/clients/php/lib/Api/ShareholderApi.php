...
/**
     ...
     * @return \DealMaker\Model\V1EntitiesShareholders
     */
    public function getShareholders($id, string $contentType = self::contentTypes['getShareholders'][0])
    {
        list($response) = $this->getShareholdersWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @throws \DealMaker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DealMaker\Model\V1EntitiesShareholders, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShareholdersWithHttpInfo($id, string $contentType = self::contentTypes['getShareholders'][0])
    {
        $request = $this->getShareholdersRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DealMaker\Model\V1EntitiesShareholders' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DealMaker\Model\V1EntitiesShareholders' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DealMaker\Model\V1EntitiesShareholders', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\DealMaker\Model\V1EntitiesShareholders';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DealMaker\Model\V1EntitiesShareholders',
     ...
     */
    public function getShareholdersAsync($id, string $contentType = self::contentTypes['getShareholders'][0])
    {
        return $this->getShareholdersAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getShareholdersAsyncWithHttpInfo($id, string $contentType = self::contentTypes['getShareholders'][0])
    {
        $returnType = '\DealMaker\Model\V1EntitiesShareholders';
        $request = $this->getShareholdersRequest($id, $contentType);
     ...
     */
    public function getShareholdersRequest($id, string $contentType = self::contentTypes['getShareholders'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getShareholders'
            );
        }
