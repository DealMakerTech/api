...
/**
 * CreateBulkUploadDetailRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class CreateBulkUploadDetailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createBulkUploadDetail_request';
    ...
    */
     ...
     * Sets file_key
     *
     * @param string $file_key The file ID
     *
     * @return self
     */
