...
class CreateCompanyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCompany_request';
    ...
    */
     ...
     * Sets country
     *
     * @param string $country The country of the company
     *
     * @return self
     */
     ...
     * Sets street
     *
     * @param string $street The street of the company
     *
     * @return self
     */
     ...
     * Sets line_2
     *
     * @param string|null $line_2 The second line of the address of the company
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string $state The state of the company
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code The postal code/zip code of the company
     *
     * @return self
     */
     ...
     * Sets primary_color
     *
     * @param string|null $primary_color The primary color of the company
     *
     * @return self
     */
