...
class CreateEmailTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createEmailTemplate_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['json_content'] === null) {
            $invalidProperties[] = "'json_content' can't be null";
        }
     ...
     * Sets json_content
     *
     * @param string $json_content The json content of the email template
     *
     * @return self
     */
     ...
     * Sets html_content
     *
     * @param string $html_content The HTML content markup
     *
     * @return self
     */
