...
/**
 * CreateIndividualProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class CreateIndividualProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createIndividualProfile_request';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email User email which is associated with individual investor profile.
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name The first name of the individual investor profile (required).
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name The last name of the individual investor profile (required)
     *
     * @return self
     */
     ...
     * Sets suffix
     *
     * @param string|null $suffix The suffix of the individual investor profile
     *
     * @return self
     */
     ...
     * Sets date_of_birth
     *
     * @param string|null $date_of_birth The date of birth of the investor profile (required)
     *
     * @return self
     */
     ...
     * Sets taxpayer_id
     *
     * @param string|null $taxpayer_id The taxpayer identification number of the investor profile (required)
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number of the investor profile (required)
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The country of the individual investor profile (required)
     *
     * @return self
     */
     ...
     * Sets street_address
     *
     * @param string|null $street_address The street address of the individual investor profile (required)
     *
     * @return self
     */
     ...
     * Sets unit2
     *
     * @param string|null $unit2 The street address line 2 of the individual investor profile
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The city of the individual investor profile (required)
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The region or state of the individual investor profile (required)
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code or zipcode of the individual investor profile (required)
     *
     * @return self
     */
