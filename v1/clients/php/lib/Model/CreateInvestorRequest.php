...
/**
 * CreateInvestorRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class CreateInvestorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createInvestor_request';
    ...
    */
     ...
     *
     * @param \DateTime|null $warrant_expiry_date The warrant expiry date of the investor.
     *
     * @return self
     */
     ...
     *
     * @param int|null $warrant_certificate_number The certificate number of the investor.
     *
     * @return self
     */
     ...
     *
     * @param float|null $allocated_amount The allocation amount of the investor.
     *
     * @return self
     */
     ...
     *
     * @param string|null $allocation_unit The allocation unit of the investor.
     *
     * @return self
     */
