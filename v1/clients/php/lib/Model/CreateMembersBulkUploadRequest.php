...
/**
 * CreateMembersBulkUploadRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class CreateMembersBulkUploadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createMembersBulkUpload_request';
    ...
    protected static $openAPITypes = [
        'csv_file' => '\SplFileObject',
        'send_notification' => 'bool',
        'offsite_shareholder' => 'bool',
    ...
    {
        $this->setIfExists('csv_file', $data ?? [], null);
        $this->setIfExists('send_notification', $data ?? [], false);
        $this->setIfExists('offsite_shareholder', $data ?? [], false);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['csv_file'] === null) {
            $invalidProperties[] = "'csv_file' can't be null";
        }
    ...
    {
        return $this->container['csv_file'];
    }

    /**
     * Sets csv_file
     *
     * @param \SplFileObject $csv_file The file csv
     *
     * @return self
     */
    ...
    {
        if (is_null($csv_file)) {
            throw new \InvalidArgumentException('non-nullable csv_file cannot be null');
        }
        $this->container['csv_file'] = $csv_file;
     ...
     *
     * @param bool|null $send_notification Send notification to the user
     *
     * @return self
     */
     ...
     *
     * @param bool|null $offsite_shareholder Offside shareholder
     *
     * @return self
     */
