...
/**
 * PatchCorporationProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class PatchCorporationProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchCorporationProfile_request';
    ...
    protected static $openAPITypes = [
        ...
        'beneficial_owners_phone_number' => 'string[]'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'beneficial_owners_phone_number' => false
    ];
    ...
    protected static $setters = [
        ...
        'beneficial_owners_phone_number' => 'setBeneficialOwnersPhoneNumber'
    ];
    ...
    protected static $getters = [
        ...
        'beneficial_owners_phone_number' => 'getBeneficialOwnersPhoneNumber'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('beneficial_owners_phone_number', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets country
     *
     * @param string|null $country Corporation country.
     *
     * @return self
     */
     ...
     *
     * @param string|null $signing_officer_country Signing officer country.
     *
     * @return self
     */
    ...
    /**
     * Gets beneficial_owners_phone_number
     *
     * @return string[]|null
     */
    public function getBeneficialOwnersPhoneNumber()
    {
        return $this->container['beneficial_owners_phone_number'];
    }

    /**
     * Sets beneficial_owners_phone_number
     *
     * @param string[]|null $beneficial_owners_phone_number The list of phone numbers for the beneficial owners (required for beneficial owner 1).
     *
     * @return self
     */
    public function setBeneficialOwnersPhoneNumber($beneficial_owners_phone_number)
    {
        if (is_null($beneficial_owners_phone_number)) {
            throw new \InvalidArgumentException('non-nullable beneficial_owners_phone_number cannot be null');
        }
        $this->container['beneficial_owners_phone_number'] = $beneficial_owners_phone_number;
