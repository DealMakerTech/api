...
/**
 * PatchDealsIdPlatformEmailsDomainRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class PatchDealsIdPlatformEmailsDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchDealsIdPlatformEmailsDomain_request';
    ...
    */
     ...
     * Sets sender_name
     *
     * @param string $sender_name The sender name.
     *
     * @return self
     */
     ...
     * Sets sender_email
     *
     * @param string $sender_email The sender email. It must match an authenticated domain.
     *
     * @return self
     */
