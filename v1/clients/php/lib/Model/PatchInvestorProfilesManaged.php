...
/**
 * PatchInvestorProfilesManaged Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchInvestorProfilesManaged implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchInvestorProfilesManaged';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the provider.
     *
     * @return self
     */
     ...
     * Sets provider_email
     *
     * @param string|null $provider_email The email of the provider.
     *
     * @return self
     */
     ...
     * Sets street_address
     *
     * @param string|null $street_address The street address of the provider.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The city of the provider.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The region or state of the provider.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code or zipcode of the provider.
     *
     * @return self
     */
     ...
     * Sets taxpayer_id
     *
     * @param string|null $taxpayer_id The taxpayer identification number of the provider.
     *
     * @return self
     */
     ...
     * Sets confirmation
     *
     * @param bool|null $confirmation Confirms that the provider is able to custody these securities and release respective funds in order to complete the purchase.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_account_number The account number of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_first_name The first name of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_last_name The last name of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_street_address The street address of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_city The city of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_region The region or state of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_postal_code The postal code or zipcode of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_date_of_birth The date of birth of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_taxpayer_id The taxpayer identification number of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_phone_number The phone number of the beneficiary.
     *
     * @return self
     */
