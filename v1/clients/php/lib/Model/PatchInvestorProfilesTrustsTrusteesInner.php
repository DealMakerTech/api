...
/**
 * PatchInvestorProfilesTrustsTrusteesInner Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class PatchInvestorProfilesTrustsTrusteesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchInvestorProfilesTrusts_trustees_inner';
    ...
    */
     ...
     * Sets index
     *
     * @param int $index The index of the trustee.
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name The list of first names for the trustees (required for trustee 1).
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name The list of last names for the trustees (required for trustee 1).
     *
     * @return self
     */
     ...
     * Sets suffix
     *
     * @param string|null $suffix The list of suffixes for the trustees.
     *
     * @return self
     */
     ...
     * Sets street_address
     *
     * @param string|null $street_address The list of street addresses for the trustees (required for trustee 1).
     *
     * @return self
     */
     ...
     * Sets unit2
     *
     * @param string|null $unit2 The list of street address line 2 for the trustees.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The list of cities for the trustees (required for trustee 1).
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The list of regions or states for the trustees (required for trustee 1).
     *
     * @return self
     */
     ...
     * Sets date_of_birth
     *
     * @param string|null $date_of_birth The list of dates of birth for the trustees (required for trustee 1).
     *
     * @return self
     */
     ...
     * Sets taxpayer_id
     *
     * @param string|null $taxpayer_id The list of taxpayer identification numbers for the trustees (required for trustee 1).
     *
     * @return self
     */
