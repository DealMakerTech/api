...
/**
 * PatchJointProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class PatchJointProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchJointProfile_request';
    ...
    protected static $setters = [
        ...
        'joint_holder_country' => 'setJointHolderCountry',
    ...
    protected static $getters = [
        ...
        'joint_holder_country' => 'getJointHolderCountry',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('joint_holder_country', $data ?? [], null);
    ...
    */
     ...
     * Sets joint_type
     *
     * @param string|null $joint_type The kind of joint investor.
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name The first name of the investor profile.
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name The last name of the investor profile.
     *
     * @return self
     */
     ...
     * Sets suffix
     *
     * @param string|null $suffix The suffix of the investor profile.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The country the investor profile.
     *
     * @return self
     */
     ...
     * Sets street_address
     *
     * @param string|null $street_address The street address of the investor profile.
     *
     * @return self
     */
     ...
     * Sets unit2
     *
     * @param string|null $unit2 The street address line 2 of the investor profile.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The city of the investor profile.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The region or State of the investor profile.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code or zipcode of the investor profile.
     *
     * @return self
     */
     ...
     * Sets date_of_birth
     *
     * @param string|null $date_of_birth The date of birth of the investor profile.
     *
     * @return self
     */
     ...
     * Sets taxpayer_id
     *
     * @param string|null $taxpayer_id The taxpayer identification number of the investor profile.
     *
     * @return self
     */
     ...
     * Sets income
     *
     * @param float|null $income The income of the investor profile.
     *
     * @return self
     */
     ...
     * Sets net_worth
     *
     * @param float|null $net_worth The net worth of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param float|null $reg_cf_prior_offerings_amount The prior offerings amount of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_first_name The joint holder first name of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_last_name The joint holder last name of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_suffix The suffix of the individual investor profile.
     *
     * @return self
     */
    ...
    /**
     * Gets joint_holder_country
     *
     * @return string|null
     */
    public function getJointHolderCountry()
    {
        return $this->container['joint_holder_country'];
    }

    /**
     * Sets joint_holder_country
     *
     * @param string|null $joint_holder_country The joint holder country of the investor profile.
     *
     * @return self
     */
    public function setJointHolderCountry($joint_holder_country)
    {
        if (is_null($joint_holder_country)) {
            throw new \InvalidArgumentException('non-nullable joint_holder_country cannot be null');
        }
        $this->container['joint_holder_country'] = $joint_holder_country;
     ...
     *
     * @param string|null $joint_holder_street_address The joint holder street address of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_unit2 The Joint holder street address line 2 of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_city The Joint holder city of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_region The joint holder region or state of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_postal_code The joint holder postal code or zipcode of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_date_of_birth The joint holder date of birth of the investor profile.
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_taxpayer_id The joint holder taxpayer identification number of the investor profile.
     *
     * @return self
     */
