...
/**
 * PatchTrustProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class PatchTrustProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchTrustProfile_request';
    ...
    protected static $setters = [
        ...
        'trustee_country' => 'setTrusteeCountry',
    ...
    protected static $getters = [
        ...
        'trustee_country' => 'getTrusteeCountry',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('trustee_country', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the trust.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param string|null $date The creation date of the trust.
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number of the trust.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country Trust country.
     *
     * @return self
     */
     ...
     * Sets street_address
     *
     * @param string|null $street_address Trust street address.
     *
     * @return self
     */
     ...
     * Sets unit2
     *
     * @param string|null $unit2 Trust street address line 2.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city Trust city.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region Trust region or state.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Trust postal code or zipcode.
     *
     * @return self
     */
    ...
    /**
     * Gets trustee_country
     *
     * @return string|null
     */
    public function getTrusteeCountry()
    {
        return $this->container['trustee_country'];
    }

    /**
     * Sets trustee_country
     *
     * @param string|null $trustee_country Trustee country.
     *
     * @return self
     */
    public function setTrusteeCountry($trustee_country)
    {
        if (is_null($trustee_country)) {
            throw new \InvalidArgumentException('non-nullable trustee_country cannot be null');
        }
        $this->container['trustee_country'] = $trustee_country;
