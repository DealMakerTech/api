...
/**
 * PostInvestorProfilesCorporations Class Doc Comment
 *
 * @category Class
 ...
 */
class PostInvestorProfilesCorporations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postInvestorProfilesCorporations';
    ...
    protected static $openAPITypes = [
        ...
        'beneficial_owners' => '\DealMaker\Model\PostInvestorProfilesCorporationsBeneficialOwnersInner[]'
    ];
    ...
    */
     ...
     *
     * @param string|null $signing_officer_title The title of the signing officer.
     *
     * @return self
     */
     ...
     *
     * @return \DealMaker\Model\PostInvestorProfilesCorporationsBeneficialOwnersInner[]|null
     */
     ...
     *
     * @param \DealMaker\Model\PostInvestorProfilesCorporationsBeneficialOwnersInner[]|null $beneficial_owners beneficial_owners
     *
     * @return self
     */
