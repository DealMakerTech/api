...
/**
 * SendPortalInviteRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class SendPortalInviteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sendPortalInvite_request';
    ...
    */
     ...
     * Sets subject
     *
     * @param string|null $subject The custom subject of the invite email
     *
     * @return self
     */
     ...
     * Sets email_content
     *
     * @param string|null $email_content The custom email content of the invite email
     *
     * @return self
     */
