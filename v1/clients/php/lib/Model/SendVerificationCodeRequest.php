...
/**
 * SendVerificationCodeRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class SendVerificationCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sendVerificationCode_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['login_token'] === null) {
            $invalidProperties[] = "'login_token' can't be null";
        }
     ...
     * Sets login_token
     *
     * @param string $login_token The token containing the user information.
     *
     * @return self
     */
