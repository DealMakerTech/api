...
/**
 * V1EntitiesAddress Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Address';
    ...
    */
     ...
     * Sets line_2
     *
     * @param string|null $line_2 The second line.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code/zip code.
     *
     * @return self
     */
