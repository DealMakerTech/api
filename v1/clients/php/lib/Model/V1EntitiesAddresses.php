...
/**
 * V1EntitiesAddresses Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesAddresses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Addresses';
    ...
    protected static $openAPITypes = [
        'items' => '\DealMaker\Model\V1EntitiesAddress'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \DealMaker\Model\V1EntitiesAddress|null
     */
     ...
     * Sets items
     *
     * @param \DealMaker\Model\V1EntitiesAddress|null $items items
     *
     * @return self
     */
