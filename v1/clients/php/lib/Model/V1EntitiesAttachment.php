...
/**
 * V1EntitiesAttachment Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Attachment';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url The attachment url.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The attachment status.
     *
     * @return self
     */
