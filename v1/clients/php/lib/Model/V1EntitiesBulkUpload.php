...
/**
 * V1EntitiesBulkUpload Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesBulkUpload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_BulkUpload';
    ...
    */
    ...
    {
        return $this->container['file_identifier'];
    }

    /**
     * Sets file_identifier
     *
     * @param string|null $file_identifier The file identifier [shareholder, investor]
     *
     * @return self
     */
    public function setFileIdentifier($file_identifier)
    {
        if (is_null($file_identifier)) {
            throw new \InvalidArgumentException('non-nullable file_identifier cannot be null');
        }
        $this->container['file_identifier'] = $file_identifier;
