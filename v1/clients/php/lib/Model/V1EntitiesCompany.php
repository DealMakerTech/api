...
/**
 * V1EntitiesCompany Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesCompany implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Company';
    ...
    protected static $openAPITypes = [
        ...
        'reply_email' => 'string',
        'company_url' => 'string',
        'addresses' => '\DealMaker\Model\V1EntitiesAddresses',
        'portals' => '\DealMaker\Model\V1EntitiesCompanyDeals',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('portals', $data ?? [], null);
    ...
    */
     ...
     * Sets type
     *
     * @param int|null $type The entity company.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the company.
     *
     * @return self
     */
     ...
     * Sets reply_email
     *
     * @param string|null $reply_email The reply email of the company.
     *
     * @return self
     */
     ...
     * Sets company_url
     *
     * @param string|null $company_url The url of the company.
     *
     * @return self
     */
     ...
     * Gets addresses
     *
     * @return \DealMaker\Model\V1EntitiesAddresses|null
     */
     ...
     * Sets addresses
     *
     * @param \DealMaker\Model\V1EntitiesAddresses|null $addresses addresses
     *
     * @return self
     */
     ...
     * Gets portals
     *
     * @return \DealMaker\Model\V1EntitiesCompanyDeals|null
     */
     ...
     * Sets portals
     *
     * @param \DealMaker\Model\V1EntitiesCompanyDeals|null $portals portals
     *
     * @return self
     */
    ...
    {
        if (is_null($portals)) {
            throw new \InvalidArgumentException('non-nullable portals cannot be null');
        }
     ...
     * Sets primary_color
     *
     * @param string|null $primary_color The primary color of the company. This should be a hex color code, with the leading \"#\".
     *
     * @return self
     */
