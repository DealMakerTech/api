...
/**
 * V1EntitiesCompanyDeal Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesCompanyDeal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_CompanyDeal';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The deal title.
     *
     * @return self
     */
