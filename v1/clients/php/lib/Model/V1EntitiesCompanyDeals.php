...
/**
 * V1EntitiesCompanyDeals Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesCompanyDeals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_CompanyDeals';
    ...
    protected static $openAPITypes = [
        'items' => '\DealMaker\Model\V1EntitiesCompanyDeal'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \DealMaker\Model\V1EntitiesCompanyDeal|null
     */
     ...
     * Sets items
     *
     * @param \DealMaker\Model\V1EntitiesCompanyDeal|null $items items
     *
     * @return self
     */
