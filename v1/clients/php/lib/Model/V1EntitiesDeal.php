...
/**
 * V1EntitiesDeal Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesDeal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Deal';
    ...
    protected static $openAPITypes = [
        ...
        'price_per_security' => 'float',
        'minimum_investment' => 'int',
        'maximum_investment' => 'int',
        'issuer' => '\DealMaker\Model\V1EntitiesDealIssuer',
        'enterprise' => '\DealMaker\Model\V1EntitiesDealEnterprise',
        'deal_type' => 'string',
        'investors' => '\DealMaker\Model\V1EntitiesDealInvestorMetrics',
        'funding' => '\DealMaker\Model\V1EntitiesDealFundingMetrics'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'security_type' => null,
        'price_per_security' => 'float',
        'minimum_investment' => 'int32',
        'maximum_investment' => 'int32',
        'issuer' => null,
        'enterprise' => null,
        'deal_type' => null,
        'investors' => null,
    ...
    protected static array $openAPINullables = [
		...
		'currency' => false,
		'security_type' => false,
		'price_per_security' => false,
		'minimum_investment' => false,
		'maximum_investment' => false,
		'issuer' => false,
		'enterprise' => false,
		'deal_type' => false,
		'investors' => false,
    ...
    protected static $attributeMap = [
        ...
        'price_per_security' => 'price_per_security',
    ...
    protected static $setters = [
        ...
        'price_per_security' => 'setPricePerSecurity',
        'minimum_investment' => 'setMinimumInvestment',
        'maximum_investment' => 'setMaximumInvestment',
        'issuer' => 'setIssuer',
    ...
    protected static $getters = [
        ...
        'price_per_security' => 'getPricePerSecurity',
        'minimum_investment' => 'getMinimumInvestment',
        'maximum_investment' => 'getMaximumInvestment',
        'issuer' => 'getIssuer',
    ...
    public const STATE_AMENDING = 'amending';
    public const STATE_ENDING = 'ending';
    public const DEAL_TYPE_OTHER_OR_UNKNOWN = 'other_or_unknown';
    public const DEAL_TYPE_DM_PLUS = 'dm_plus';
    public const DEAL_TYPE_DM_BASIC = 'dm_basic';
    public const DEAL_TYPE_MINI_DEAL = 'mini_deal';
    public const DEAL_TYPE_REG_CF = 'reg_cf';
    public const DEAL_TYPE_REG_A = 'reg_a';
    public const DEAL_TYPE_WARRANTS = 'warrants';
    ...
    {
        return [
            self::DEAL_TYPE_OTHER_OR_UNKNOWN,
            self::DEAL_TYPE_DM_PLUS,
            self::DEAL_TYPE_DM_BASIC,
            self::DEAL_TYPE_MINI_DEAL,
            self::DEAL_TYPE_REG_CF,
            self::DEAL_TYPE_REG_A,
            self::DEAL_TYPE_WARRANTS,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('price_per_security', $data ?? [], null);
        $this->setIfExists('minimum_investment', $data ?? [], null);
        $this->setIfExists('maximum_investment', $data ?? [], null);
        $this->setIfExists('issuer', $data ?? [], null);
        $this->setIfExists('enterprise', $data ?? [], null);
        $this->setIfExists('deal_type', $data ?? [], null);
        $this->setIfExists('investors', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['deal_type']) && !in_array($this->container['deal_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'deal_type', must be one of '%s'",
                $this->container['deal_type'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets id
     *
     * @param int|null $id The deal's unique id.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title The deal title.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state The deal state.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The primary currency associated with the deal.
     *
     * @return self
     */
     ...
     * Sets security_type
     *
     * @param string|null $security_type The deal security type.
     *
     * @return self
     */
    ...
    /**
     * Gets price_per_security
     *
     * @return float|null
     */
    public function getPricePerSecurity()
    {
        return $this->container['price_per_security'];
    }

    /**
     * Sets price_per_security
     *
     * @param float|null $price_per_security The deal price per security.
     *
     * @return self
     */
    public function setPricePerSecurity($price_per_security)
    {
        if (is_null($price_per_security)) {
            throw new \InvalidArgumentException('non-nullable price_per_security cannot be null');
        }
        $this->container['price_per_security'] = $price_per_security;

        return $this;
    }

    /**
     * Gets minimum_investment
     *
     * @return int|null
     */
    public function getMinimumInvestment()
    {
        return $this->container['minimum_investment'];
    }

    /**
     * Sets minimum_investment
     *
     * @param int|null $minimum_investment The minimum investment amount, in cents.
     *
     * @return self
     */
    public function setMinimumInvestment($minimum_investment)
    {
        if (is_null($minimum_investment)) {
            throw new \InvalidArgumentException('non-nullable minimum_investment cannot be null');
        }
        $this->container['minimum_investment'] = $minimum_investment;

        return $this;
    }

    /**
     * Gets maximum_investment
     *
     * @return int|null
     */
    public function getMaximumInvestment()
    {
        return $this->container['maximum_investment'];
    }

    /**
     * Sets maximum_investment
     *
     * @param int|null $maximum_investment The maximum investment amount, in cents.
     *
     * @return self
     */
    public function setMaximumInvestment($maximum_investment)
    {
        if (is_null($maximum_investment)) {
            throw new \InvalidArgumentException('non-nullable maximum_investment cannot be null');
        }
        $this->container['maximum_investment'] = $maximum_investment;
     ...
     * Gets issuer
     *
     * @return \DealMaker\Model\V1EntitiesDealIssuer|null
     */
     ...
     * Sets issuer
     *
     * @param \DealMaker\Model\V1EntitiesDealIssuer|null $issuer issuer
     *
     * @return self
     */
     ...
     * Gets enterprise
     *
     * @return \DealMaker\Model\V1EntitiesDealEnterprise|null
     */
     ...
     * Sets enterprise
     *
     * @param \DealMaker\Model\V1EntitiesDealEnterprise|null $enterprise enterprise
     *
     * @return self
     */
     ...
     * Sets deal_type
     *
     * @param string|null $deal_type The deal type.
     *
     * @return self
     */
    public function setDealType($deal_type)
    {
        if (is_null($deal_type)) {
            throw new \InvalidArgumentException('non-nullable deal_type cannot be null');
        }
        $allowedValues = $this->getDealTypeAllowableValues();
        if (!in_array($deal_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'deal_type', must be one of '%s'",
                    $deal_type,
     ...
     * Gets investors
     *
     * @return \DealMaker\Model\V1EntitiesDealInvestorMetrics|null
     */
     ...
     * Sets investors
     *
     * @param \DealMaker\Model\V1EntitiesDealInvestorMetrics|null $investors investors
     *
     * @return self
     */
    public function setInvestors($investors)
    {
        if (is_null($investors)) {
            throw new \InvalidArgumentException('non-nullable investors cannot be null');
        }
     ...
     * Gets funding
     *
     * @return \DealMaker\Model\V1EntitiesDealFundingMetrics|null
     */
     ...
     * Sets funding
     *
     * @param \DealMaker\Model\V1EntitiesDealFundingMetrics|null $funding funding
     *
     * @return self
     */
