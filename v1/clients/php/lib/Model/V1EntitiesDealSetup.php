...
/**
 * V1EntitiesDealSetup Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesDealSetup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_DealSetup';
    ...
    protected static $openAPITypes = [
        ...
        'company_id' => 'int',
        'link' => 'string',
        'representative' => '\DealMaker\Model\V1EntitiesDealSetupUser'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('high_risk', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The deal setup id.
     *
     * @return self
     */
     ...
     * Sets deal_name
     *
     * @param string|null $deal_name The title/name of the deal.
     *
     * @return self
     */
     ...
     * Sets deal_type
     *
     * @param int|null $deal_type The type of the deal.
     *
     * @return self
     */
     ...
     *
     * @param string|null $invoice_contact The invoice email address.
     *
     * @return self
     */
    ...
    {
        return $this->container['high_risk'];
    }

    /**
     * Sets high_risk
     *
     * @param bool|null $high_risk Determine if the deal is a high risk or not.
     *
     * @return self
     */
    public function setHighRisk($high_risk)
    {
        if (is_null($high_risk)) {
            throw new \InvalidArgumentException('non-nullable high_risk cannot be null');
        }
        $this->container['high_risk'] = $high_risk;
     ...
     * Sets link
     *
     * @param string|null $link Link to the second page of the deal setup
     *
     * @return self
     */
     ...
     * Gets representative
     *
     * @return \DealMaker\Model\V1EntitiesDealSetupUser|null
     */
     ...
     * Sets representative
     *
     * @param \DealMaker\Model\V1EntitiesDealSetupUser|null $representative representative
     *
     * @return self
     */
