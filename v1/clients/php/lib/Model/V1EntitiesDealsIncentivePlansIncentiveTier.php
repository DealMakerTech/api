...
class V1EntitiesDealsIncentivePlansIncentiveTier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The incentive tier status.
     *
     * @return self
     */
     ...
     *
     * @param int|null $humanized_index The incentive tier humanized index.
     *
     * @return self
     */
     ...
     * Sets start_at
     *
     * @param \DateTime|null $start_at The incentive plan start date.
     *
     * @return self
     */
