...
/**
 * V1EntitiesDealsPlatformEmailsDomainSettings Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesDealsPlatformEmailsDomainSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Deals_PlatformEmails_DomainSettings';
    ...
    */
     ...
     * Sets sender_name
     *
     * @param string|null $sender_name The name of the sender.
     *
     * @return self
     */
     ...
     * Sets sender_email
     *
     * @param string|null $sender_email The email address of the sender.
     *
     * @return self
     */
