...
/**
 * V1EntitiesDealsProgressKinds Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesDealsProgressKinds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Deals_ProgressKinds';
    ...
    protected static $openAPITypes = [
        'investment_amount' => '\DealMaker\Model\V1EntitiesDealsProgressColumn',
        'number_of_investments' => '\DealMaker\Model\V1EntitiesDealsProgressColumn',
        'number_of_securities' => '\DealMaker\Model\V1EntitiesDealsProgressColumn'
    ];
    ...
    protected static $setters = [
        ...
        'number_of_investments' => 'setNumberOfInvestments',
    ...
    protected static $getters = [
        ...
        'number_of_investments' => 'getNumberOfInvestments',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_of_investments', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \DealMaker\Model\V1EntitiesDealsProgressColumn|null $investment_amount investment_amount
     *
     * @return self
     */
    ...
    /**
     * Gets number_of_investments
     *
     * @return \DealMaker\Model\V1EntitiesDealsProgressColumn|null
     */
    public function getNumberOfInvestments()
    {
        return $this->container['number_of_investments'];
    }

    /**
     * Sets number_of_investments
     *
     * @param \DealMaker\Model\V1EntitiesDealsProgressColumn|null $number_of_investments number_of_investments
     *
     * @return self
     */
    public function setNumberOfInvestments($number_of_investments)
    {
        if (is_null($number_of_investments)) {
            throw new \InvalidArgumentException('non-nullable number_of_investments cannot be null');
        }
        $this->container['number_of_investments'] = $number_of_investments;
     ...
     *
     * @param \DealMaker\Model\V1EntitiesDealsProgressColumn|null $number_of_securities number_of_securities
     *
     * @return self
     */
