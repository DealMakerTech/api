...
/**
 * V1EntitiesDealsProgressPageSummaryItem Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesDealsProgressPageSummaryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Deals_ProgressPage_SummaryItem';
    ...
    */
     ...
     * Sets highlighted
     *
     * @param bool|null $highlighted Highlighted
     *
     * @return self
     */
    public function setHighlighted($highlighted)
    {
        if (is_null($highlighted)) {
            throw new \InvalidArgumentException('non-nullable highlighted cannot be null');
        }
