...
/**
 * V1EntitiesEmailEvent Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesEmailEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_EmailEvent';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The id of the email event.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the shareholder.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email The email of the shareholder.
     *
     * @return self
     */
     ...
     * Sets delivered
     *
     * @param int|null $delivered The number of email delivered.
     *
     * @return self
     */
     ...
     * Sets opened
     *
     * @param int|null $opened The number of email opened.
     *
     * @return self
     */
     ...
     * Sets clicked
     *
     * @param int|null $clicked The number of email clicked.
     *
     * @return self
     */
     ...
     * Sets bounced
     *
     * @param int|null $bounced The number of email bounced.
     *
     * @return self
     */
