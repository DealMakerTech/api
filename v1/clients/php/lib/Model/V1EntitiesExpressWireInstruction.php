...
/**
 * V1EntitiesExpressWireInstruction Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesExpressWireInstruction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_ExpressWireInstruction';
    ...
    {
        $this->setIfExists('investor_id', $data ?? [], null);
        ...
        $this->setIfExists('aba_routing', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['investor_id'];
    }

    /**
     * Sets investor_id
     *
     * @param string|null $investor_id The id of the investor
     *
     * @return self
     */
    public function setInvestorId($investor_id)
    {
        if (is_null($investor_id)) {
            throw new \InvalidArgumentException('non-nullable investor_id cannot be null');
        }
        $this->container['investor_id'] = $investor_id;
     ...
     * Sets bank_name
     *
     * @param string|null $bank_name Name of the bank for the payment
     *
     * @return self
     */
     ...
     * Sets bank_address
     *
     * @param string|null $bank_address Address of the bank for the payment
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_address Address of the beneficiary for the payment
     *
     * @return self
     */
     ...
     *
     * @param string|null $beneficiary_name Name of the beneficiary for the payment
     *
     * @return self
     */
     ...
     * Sets account_number
     *
     * @param string|null $account_number Account number for the payment
     *
     * @return self
     */
    ...
    {
        return $this->container['aba_routing'];
    }

    /**
     * Sets aba_routing
     *
     * @param string|null $aba_routing Aba routing number for the payment
     *
     * @return self
     */
    public function setAbaRouting($aba_routing)
    {
        if (is_null($aba_routing)) {
            throw new \InvalidArgumentException('non-nullable aba_routing cannot be null');
        }
        $this->container['aba_routing'] = $aba_routing;
     ...
     * Sets swift_code
     *
     * @param string|null $swift_code Swift code for the payment
     *
     * @return self
     */
