...
/**
 * V1EntitiesInvestorOtpAccessLink Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesInvestorOtpAccessLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_InvestorOtpAccessLink';
    ...
    */
     ...
     * Sets access_link
     *
     * @param string|null $access_link OTP access link for the investor.
     *
     * @return self
     */
