...
/**
 * V1EntitiesInvestorProfileFieldsCorporation Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesInvestorProfileFieldsCorporation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_InvestorProfile_Fields_Corporation';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The corporation name
     *
     * @return self
     */
     ...
     *
     * @param string|null $business_number The corporation business number
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The corporation phone number
     *
     * @return self
     */
