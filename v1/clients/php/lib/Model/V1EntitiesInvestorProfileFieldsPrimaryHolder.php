...
/**
 * V1EntitiesInvestorProfileFieldsPrimaryHolder Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesInvestorProfileFieldsPrimaryHolder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_InvestorProfile_Fields_PrimaryHolder';
    ...
    */
     ...
     * Sets first_name
     *
     * @param string|null $first_name Investor profile first name
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name Investor profile last name
     *
     * @return self
     */
     ...
     * Sets suffix
     *
     * @param string|null $suffix Investor profile suffix
     *
     * @return self
     */
     ...
     * Sets date_of_birth
     *
     * @param string|null $date_of_birth The date of birth
     *
     * @return self
     */
     ...
     * Sets taxpayer_id
     *
     * @param string|null $taxpayer_id The taxpayer identification number
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number of the primary account holder
     *
     * @return self
     */
     ...
     * Sets income
     *
     * @param float|null $income The income
     *
     * @return self
     */
     ...
     * Sets net_worth
     *
     * @param float|null $net_worth The net worth
     *
     * @return self
     */
     ...
     *
     * @param float|null $reg_cf_prior_offerings_amount The prior offering amount in the last 12 months
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \DealMaker\Model\V1EntitiesInvestorProfileAddress|null
     */
     ...
     * Sets address
     *
     * @param \DealMaker\Model\V1EntitiesInvestorProfileAddress|null $address address
     *
     * @return self
     */
