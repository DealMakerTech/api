...
/**
 * V1EntitiesInvestorProfileFieldsProvider Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesInvestorProfileFieldsProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_InvestorProfile_Fields_Provider';
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email The provider email
     *
     * @return self
     */
