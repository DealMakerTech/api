...
/**
 * V1EntitiesInvestorProfileTrust Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesInvestorProfileTrust implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_InvestorProfile_Trust';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('trust_holder', $data ?? [], null);
    ...
    */
     ...
     * Gets trust_holder
     *
     * @return \DealMaker\Model\V1EntitiesInvestorProfileFieldsTrust|null
     */
    public function getTrustHolder()
    {
        return $this->container['trust_holder'];
    }

    /**
     * Sets trust_holder
     *
     * @param \DealMaker\Model\V1EntitiesInvestorProfileFieldsTrust|null $trust_holder trust_holder
     *
     * @return self
     */
    public function setTrustHolder($trust_holder)
    {
        if (is_null($trust_holder)) {
            throw new \InvalidArgumentException('non-nullable trust_holder cannot be null');
        }
        $this->container['trust_holder'] = $trust_holder;
