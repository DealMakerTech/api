...
/**
 * V1EntitiesInvestorSearchEntities Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesInvestorSearchEntities implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Investor_SearchEntities';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Search entity ID.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The full name of the entity.
     *
     * @return self
     */
    ...
    {
        return $this->container['type_num'];
    }

    /**
     * Sets type_num
     *
     * @param string|null $type_num The position in the list when beneficial owner of trustees, if none it returns null.
     *
     * @return self
     */
    public function setTypeNum($type_num)
    {
        if (is_null($type_num)) {
     ...
     *
     * @return \DealMaker\Model\V1EntitiesInvestorSearchEntitiesRequiredFields|null
     */
     ...
     *
     * @param \DealMaker\Model\V1EntitiesInvestorSearchEntitiesRequiredFields|null $required_fields required_fields
     *
     * @return self
     */
