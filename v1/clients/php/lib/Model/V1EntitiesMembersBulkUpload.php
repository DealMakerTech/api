...
/**
 * V1EntitiesMembersBulkUpload Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesMembersBulkUpload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_MembersBulkUpload';
    ...
    protected static $attributeMap = [
        ...
        'offsite_shareholder' => 'offsiteShareholder',
    ...
    protected static $setters = [
        ...
        'offsite_shareholder' => 'setOffsiteShareholder',
    ...
    protected static $getters = [
        ...
        'offsite_shareholder' => 'getOffsiteShareholder',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('offsite_shareholder', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The bulk upload ID
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The status [pending, processing, completed, failed]
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count The number of members in the bulk upload
     *
     * @return self
     */
     ...
     *
     * @param int|null $processed_count The number of processed members in the bulk upload
     *
     * @return self
     */
     ...
     * Sets error_count
     *
     * @param int|null $error_count The number of failed members in the bulk upload
     *
     * @return self
     */
     ...
     *
     * @param string|null $send_notification Send notification to the user
     *
     * @return self
     */
    ...
    /**
     * Gets offsite_shareholder
     *
     * @return string|null
     */
    public function getOffsiteShareholder()
    {
        return $this->container['offsite_shareholder'];
    }

    /**
     * Sets offsite_shareholder
     *
     * @param string|null $offsite_shareholder Offside shareholder
     *
     * @return self
     */
    public function setOffsiteShareholder($offsite_shareholder)
    {
        if (is_null($offsite_shareholder)) {
            throw new \InvalidArgumentException('non-nullable offsite_shareholder cannot be null');
        }
        $this->container['offsite_shareholder'] = $offsite_shareholder;
     ...
     * Sets email_content
     *
     * @param string|null $email_content Email content
     *
     * @return self
     */
     ...
     * Sets error_details
     *
     * @param string|null $error_details The error details
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The created at timestamp
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at The updated at timestamp
     *
     * @return self
     */
