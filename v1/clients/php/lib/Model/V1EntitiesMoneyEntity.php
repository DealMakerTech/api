...
/**
 * V1EntitiesMoneyEntity Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesMoneyEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_MoneyEntity';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The amount of money.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency of the money.
     *
     * @return self
     */
