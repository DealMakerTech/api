...
/**
 * V1EntitiesPresignedUrlResult Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesPresignedUrlResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_PresignedUrlResult';
    ...
    */
     ...
     * Sets file_key
     *
     * @param string|null $file_key The file UUID generated value.
     *
     * @return self
     */
     ...
     * Sets presigned_url
     *
     * @param string|null $presigned_url A pre-signed url by aws for interacting with a S3 bucket.
     *
     * @return self
     */
