...
/**
 * V1EntitiesSubscriptionAgreement Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class V1EntitiesSubscriptionAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_SubscriptionAgreement';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The subscription agreement id.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The subscription agreement url.
     *
     * @return self
     */
