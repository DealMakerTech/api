...
/**
 * V1EntitiesTtwReservationGetResponse Class Doc Comment
 *
 * @category Class
 * @description V1_Entities_Ttw_Reservation_GetResponse model
 * @package  DealMaker
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V1EntitiesTtwReservationGetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Ttw_Reservation_GetResponse';
    ...
    */
     ...
     * Sets token
     *
     * @param string|null $token The token for the user.
     *
     * @return self
     */
     ...
     * Sets reservation_id
     *
     * @param int|null $reservation_id The ID of the reservation.
     *
     * @return self
     */
