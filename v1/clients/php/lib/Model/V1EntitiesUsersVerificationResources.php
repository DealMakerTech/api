...
/**
 * V1EntitiesUsersVerificationResources Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesUsersVerificationResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_Users_VerificationResources';
    ...
    */
     ...
     * Sets totp_enabled
     *
     * @param bool|null $totp_enabled Check if on the authenticator app is set for the user.
     *
     * @return self
     */
     ...
     * Sets sms_enabled
     *
     * @param bool|null $sms_enabled Check if on the sms verification is set for the user.
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone The last 4 digits of the users phone number.
     *
     * @return self
     */
