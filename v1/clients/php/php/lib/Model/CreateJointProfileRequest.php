...
/**
 * CreateJointProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class CreateJointProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createJointProfile_request';
    ...
    */
     ...
     * Sets country
     *
     * @param string|null $country The country the primary holder (required).
     *
     * @return self
     */
     ...
     *
     * @param string|null $joint_holder_country The country of the joint holder (required).
     *
     * @return self
     */
