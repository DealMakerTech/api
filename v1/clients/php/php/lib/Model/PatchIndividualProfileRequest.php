...
/**
 * PatchIndividualProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  DealMaker
 * @author   OpenAPI Generator team
 ...
 */
class PatchIndividualProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchIndividualProfile_request';
    ...
    */
     ...
     * Sets first_name
     *
     * @param string|null $first_name The first name of the individual investor profile.
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name The last name of the individual investor profile.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The country of the individual investor profile.
     *
     * @return self
     */
     ...
     * Sets street_address
     *
     * @param string|null $street_address The street address of the individual investor profile.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The city of the individual investor profile.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The region or state of the individual investor profile.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code or zipcode of the individual investor profile.
     *
     * @return self
     */
