...
/**
 * V1EntitiesInvestorProfileIndividual Class Doc Comment
 *
 * @category Class
 ...
 */
class V1EntitiesInvestorProfileIndividual implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1_Entities_InvestorProfile_Individual';
    ...
    protected static $openAPITypes = [
        ...
        'complete' => 'bool',
        'account_holder' => '\DealMaker\Model\V1EntitiesInvestorProfileFieldsPrimaryHolder'
    ];
    ...
    */
     ...
     * Sets account_holder
     *
     * @param \DealMaker\Model\V1EntitiesInvestorProfileFieldsPrimaryHolder|null $account_holder account_holder
     *
     * @return self
     */
