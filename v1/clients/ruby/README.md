...
```shell
gem install ./DealMakerAPI-0.73.5.gem
```

(for development, run `gem install --dev ./DealMakerAPI-0.73.5.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'DealMakerAPI', '~> 0.73.5'
