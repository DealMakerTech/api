...
module DealMakerAPI
  class IncentivePlanApi
    ...
    def get_deal_incentive_plans_time(id, opts = {})
      data, _status_code, _headers = get_deal_incentive_plans_time_with_http_info(id, opts)
      data
    end
    ...
    def get_deal_incentive_plans_time_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncentivePlanApi.get_deal_incentive_plans_time ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncentivePlanApi.get_deal_incentive_plans_time"
      end
      # resource path
      local_var_path = '/deals/{id}/incentive_plans/time'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"IncentivePlanApi.get_deal_incentive_plans_time",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncentivePlanApi#get_deal_incentive_plans_time\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
