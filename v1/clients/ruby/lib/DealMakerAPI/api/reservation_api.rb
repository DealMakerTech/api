  ...
  class ReservationApi
    ...
    def create_reservation_with_http_info(create_reservation_request, opts = {})
      ...
      if @api_client.config.client_side_validation && create_reservation_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_reservation_request' when calling ReservationApi.create_reservation"
      end
      # resource path
      local_var_path = '/ttw/reservations'
