...
module DealMakerAPI
  class CreateDealSetupRequest
    ...
    attr_accessor :invoicing_email

    # The industry.
    attr_accessor :issuer_industry

    # Determine if the deal is a high risk or not.
    attr_accessor :prohibited_industry
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DealMakerAPI::CreateDealSetupRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DealMakerAPI::CreateDealSetupRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'issuer_industry')
        self.issuer_industry = attributes[:'issuer_industry']
      else
        self.issuer_industry = 'other'
      end

      if attributes.key?(:'prohibited_industry')
        self.prohibited_industry = attributes[:'prohibited_industry']
      else
        self.prohibited_industry = 'prohibited'
      end

      if attributes.key?(:'offering_type')
        self.offering_type = attributes[:'offering_type']
      else
        self.offering_type = 'other'
      end
    ...
    def list_invalid_properties
      ...
      if @offering_type.nil?
        invalid_properties.push('invalid value for "offering_type", offering_type cannot be nil.')
      end
    ...
    # @param [Object] issuer_industry Object to be assigned
    def issuer_industry=(issuer_industry)
      validator = EnumAttributeValidator.new('String', ["other", "beverage", "blockchain", "cannabis", "cpc", "gaming", "health", "industry", "mining", "real_estate", "retail", "tech", "psychedelics", "office_of_life_sciences", "office_of_energy_and_transportation", "office_of_real_estate_and_construction", "office_of_manufacturing", "office_of_technology", "office_of_trade_and_services", "office_of_finance", "office_of_international_corp_fin"])
      unless validator.valid?(issuer_industry)
        fail ArgumentError, "invalid value for \"issuer_industry\", must be one of #{validator.allowable_values}."
      end
      @issuer_industry = issuer_industry
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] prohibited_industry Object to be assigned
    def prohibited_industry=(prohibited_industry)
      validator = EnumAttributeValidator.new('String', ["prohibited", "not_prohibited"])
      unless validator.valid?(prohibited_industry)
        fail ArgumentError, "invalid value for \"prohibited_industry\", must be one of #{validator.allowable_values}."
      end
      @prohibited_industry = prohibited_industry
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          issuer_industry == o.issuer_industry &&
          prohibited_industry == o.prohibited_industry &&
    ...
    def hash
      [invoicing_email, issuer_industry, prohibited_industry, offering_type, title, company_id, representative].hash
    end
