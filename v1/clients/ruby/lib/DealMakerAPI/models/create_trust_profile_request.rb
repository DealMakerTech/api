...
module DealMakerAPI
  class CreateTrustProfileRequest
    ...
    def hash
      [email, us_accredited_category, name, date, country, street_address, unit2, city, region, postal_code, phone_number, trustees_first_name, trustees_last_name, trustees_suffix, trustees_country, trustees_street_address, trustees_unit_2, trustees_city, trustees_region, trustees_postal_code, trustees_date_of_birth, trustees_taxpayer_id].hash
    end
