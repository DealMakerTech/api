...
module DealMakerAPI
  class PatchCorporationProfileRequest
    ...
    def hash
      [us_accredited_category, name, country, street_address, unit2, city, region, postal_code, business_number, phone_number, signing_officer_first_name, signing_officer_last_name, signing_officer_suffix, signing_officer_country, signing_officer_street_address, signing_officer_unit2, signing_officer_city, signing_officer_region, signing_officer_postal_code, signing_officer_date_of_birth, signing_officer_taxpayer_id].hash
    end
