...
module DealMakerAPI
  class V1EntitiesDealFundingMetrics
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'funds_received')
        self.funds_received = attributes[:'funds_received']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          funds_received == o.funds_received &&
    ...
    def hash
      [amount_subscribed, funds_received, funds_pending, securities_subscribed, amount_allocated, securities_allocated, amount_accepted, securities_accepted].hash
    end
