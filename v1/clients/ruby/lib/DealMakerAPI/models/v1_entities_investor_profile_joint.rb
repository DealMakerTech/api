...
module DealMakerAPI
  ...
  class V1EntitiesInvestorProfileJoint
    ...
    attr_accessor :primary_holder

    attr_accessor :joint_holder
    ...
    def self.openapi_types
      {
        ...
        :'complete' => :'Boolean',
        :'joint_type' => :'String',
        :'primary_holder' => :'V1EntitiesInvestorProfileFieldsPrimaryHolder',
        :'joint_holder' => :'V1EntitiesInvestorProfileFieldsAccountHolder'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DealMakerAPI::V1EntitiesInvestorProfileJoint` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DealMakerAPI::V1EntitiesInvestorProfileJoint`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'primary_holder')
        self.primary_holder = attributes[:'primary_holder']
      end

      if attributes.key?(:'joint_holder')
        self.joint_holder = attributes[:'joint_holder']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          primary_holder == o.primary_holder &&
          joint_holder == o.joint_holder
    end
    ...
    def hash
      [id, user_id, email, type, us_accredited_category, complete, joint_type, primary_holder, joint_holder].hash
    end
