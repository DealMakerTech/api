...
# Unit tests for DealMakerAPI::CompanyApi
...
describe 'CompanyApi' do
  ...
  describe 'test an instance of CompanyApi' do
    it 'should create an instance of CompanyApi' do
      expect(@api_instance).to be_instance_of(DealMakerAPI::CompanyApi)
    end
  end

  # unit tests for create_bulk_upload
  # Create bulk upload record
  # Create bulk upload record
  # @param id The company id
  # @param create_bulk_upload_request 
  # @param [Hash] opts the optional parameters
  # @return [V1EntitiesBulkUpload]
  describe 'create_bulk_upload test' do
    it 'should work' do
