...
# Unit tests for DealMakerAPI::DefaultApi
...
describe 'DefaultApi' do
  ...
  describe 'test an instance of DefaultApi' do
    it 'should create an instance of DefaultApi' do
      expect(@api_instance).to be_instance_of(DealMakerAPI::DefaultApi)
    end
  end
  ...
  # unit tests for get_deals_id_progress_page_summary
  # Get the deal progress summary
  # Get the deal progress summary
  # @param id The deal id.
  # @param [Hash] opts the optional parameters
  # @return [V1EntitiesDealsProgressPageSummary]
  describe 'get_deals_id_progress_page_summary test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for get_webhooks_deal_id
  # Finds a deal using the id
  # Returns a deal
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [V1EntitiesWebhooksDeal]
  describe 'get_webhooks_deal_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_webhooks_deals_search
  # Searches for deals for a given user
  # Searches for deals for a given user
  # @param [Hash] opts the optional parameters
  # @return [V1EntitiesWebhooksSecurityToken]
  describe 'get_webhooks_deals_search test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_webhooks_security_token
  # Creates a new security token for webhook subscription
  # Creates a new security token for webhook subscription
  # @param [Hash] opts the optional parameters
  # @return [V1EntitiesWebhooksSecurityToken]
  describe 'get_webhooks_security_token test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for put_webhooks_id
  ...
  # @return [V1EntitiesWebhooksSubscription]
  describe 'put_webhooks_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
