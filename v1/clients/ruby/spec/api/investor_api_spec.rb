...
# Unit tests for DealMakerAPI::InvestorApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvestorApi' do
  before do
  ...
  describe 'test an instance of InvestorApi' do
    it 'should create an instance of InvestorApi' do
      expect(@api_instance).to be_instance_of(DealMakerAPI::InvestorApi)
    end
  end
  ...
  # unit tests for bulk_upload_investors
  # Bulk upload investors for deal investor
  # Bulk upload investors
  # @param id The deal id.
  # @param bulk_upload_investors_request 
  # @param [Hash] opts the optional parameters
  # @return [V1EntitiesInvestor]
  describe 'bulk_upload_investors test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_investor
  ...
  describe 'list_investors test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_investor
  # Patch a deal investor
  # Patch deal investor
  # @param id The deal id.
  # @param investor_id The investor id.
  # @param patch_investor_request 
  # @param [Hash] opts the optional parameters
  # @return [V1EntitiesInvestor]
  describe 'patch_investor test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
