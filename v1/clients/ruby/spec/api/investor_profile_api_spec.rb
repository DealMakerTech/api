...
# Unit tests for DealMakerAPI::InvestorProfileApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvestorProfileApi' do
  before do
  ...
  describe 'test an instance of InvestorProfileApi' do
    it 'should create an instance of InvestorProfileApi' do
      expect(@api_instance).to be_instance_of(DealMakerAPI::InvestorProfileApi)
    end
  end
  ...
  # @option opts [Integer] :offset Pad a number of results.
  # @return [V1EntitiesInvestorProfiles]
  describe 'get_investor_profiles test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_corporation_profile
  ...
  # unit tests for patch_individual_profile
  ...
  # unit tests for patch_joint_profile
