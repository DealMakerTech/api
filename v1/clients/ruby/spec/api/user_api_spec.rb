...
# Unit tests for DealMakerAPI::UserApi
...
describe 'UserApi' do
  ...
  describe 'test an instance of UserApi' do
    it 'should create an instance of UserApi' do
      expect(@api_instance).to be_instance_of(DealMakerAPI::UserApi)
    end
  end
  ...
  # Update user password
  # @param id 
  # @param update_user_password_request 
  # @param [Hash] opts the optional parameters
  # @return [V1EntitiesUser]
  ...
  # unit tests for verify_sms_verification
  # Verify a SMS Verification by creating a two factor channel of sms type
  # Verify a SMS Verification by creating a two factor channel of sms type
  # @param id 
  # @param verify_sms_verification_request 
  # @param [Hash] opts the optional parameters
  # @return [V1EntitiesUsersTwoFactorChannel]
  describe 'verify_sms_verification test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
