...
# Unit tests for DealMakerAPI::CreateIndividualProfileRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DealMakerAPI::CreateIndividualProfileRequest do
  let(:instance) { DealMakerAPI::CreateIndividualProfileRequest.new }

  describe 'test an instance of CreateIndividualProfileRequest' do
    it 'should create an instance of CreateIndividualProfileRequest' do
      expect(instance).to be_instance_of(DealMakerAPI::CreateIndividualProfileRequest)
    end
  end
