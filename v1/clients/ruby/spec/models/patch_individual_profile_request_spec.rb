...
# Unit tests for DealMakerAPI::PatchIndividualProfileRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DealMakerAPI::PatchIndividualProfileRequest do
  let(:instance) { DealMakerAPI::PatchIndividualProfileRequest.new }

  describe 'test an instance of PatchIndividualProfileRequest' do
    it 'should create an instance of PatchIndividualProfileRequest' do
      expect(instance).to be_instance_of(DealMakerAPI::PatchIndividualProfileRequest)
    end
  end
