...
# Unit tests for DealMakerAPI::PatchInvestorProfilesManaged
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DealMakerAPI::PatchInvestorProfilesManaged do
  let(:instance) { DealMakerAPI::PatchInvestorProfilesManaged.new }

  describe 'test an instance of PatchInvestorProfilesManaged' do
    it 'should create an instance of PatchInvestorProfilesManaged' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(DealMakerAPI::PatchInvestorProfilesManaged)
    end
  end
  ...
  describe 'test attribute "provider_email"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
