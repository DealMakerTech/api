...
# Unit tests for DealMakerAPI::V1EntitiesInvestorProfileIndividual
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DealMakerAPI::V1EntitiesInvestorProfileIndividual do
  let(:instance) { DealMakerAPI::V1EntitiesInvestorProfileIndividual.new }

  describe 'test an instance of V1EntitiesInvestorProfileIndividual' do
    it 'should create an instance of V1EntitiesInvestorProfileIndividual' do
      expect(instance).to be_instance_of(DealMakerAPI::V1EntitiesInvestorProfileIndividual)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["individual"])
